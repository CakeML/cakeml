...
(* TODO Move evaluation infrastructure out? *)
(* TODO Clean up testing (move out, cover more/all cases, don't reevaluate same
   elements *)
...
val _ = new_theory "toDafnyAst";

val maximum_string = "(Program ((Module.Module (Name.Name \"_System\") () (Some ((ModuleItem.Newtype (Newtype.Newtype (Name.Name \"nat\") () (Type.Primitive (Primitive.Int)) (NewtypeRange.NoRange) () (None) ((Attribute.Attribute \"axiom\" ())))) (ModuleItem.Datatype (Datatype.Datatype (Name.Name \"Tuple2\") (Ident.Ident (Name.Name \"_System\")) ((TypeArgDecl.TypeArgDecl (Ident.Ident (Name.Name \"T0\")) ()) (TypeArgDecl.TypeArgDecl (Ident.Ident (Name.Name \"T1\")) ())) ((DatatypeCtor.DatatypeCtor (Name.Name \"___hMake2\") ((DatatypeDtor.DatatypeDtor (Formal.Formal (Name.Name \"_0\") (Type.TypeArg (Ident.Ident (Name.Name \"T0\"))) ()) (Some \"_0\")) (DatatypeDtor.DatatypeDtor (Formal.Formal (Name.Name \"_1\") (Type.TypeArg (Ident.Ident (Name.Name \"T1\"))) ()) (Some \"_1\"))) true)) () false ())) (ModuleItem.Datatype (Datatype.Datatype (Name.Name \"Tuple0\") (Ident.Ident (Name.Name \"_System\")) () ((DatatypeCtor.DatatypeCtor (Name.Name \"___hMake0\") () false)) () false ()))))) (Module.Module (Name.Name \"_module\") () (Some ((ModuleItem.Class (Class.Class (Name.Name \"__default\") (Ident.Ident (Name.Name \"_module\")) () () () ((ClassItem.Method (Method.Method true true (None) (Name.Name \"Maximum\") () ((Formal.Formal (Name.Name \"values\") (Type.Array (Type.Primitive (Primitive.Int)) 1) ())) ((Statement.DeclareVar (Name.Name \"max\") (Type.Primitive (Primitive.Int)) (Some (Expression.InitializationValue (Type.Primitive (Primitive.Int))))) (Statement.Call (Expression.Companion ((Ident.Ident (Name.Name \"_module\")) (Ident.Ident (Name.Name \"__default\")))) (CallName.CallName (Name.Name \"SayHello\") (None) (CallSignature.CallSignature ((Formal.Formal (Name.Name \"who\") (Type.Primitive (Primitive.String)) ())))) () ((Expression.Literal (Literal.StringLiteral \"CakeML\" false))) (None)) (Statement.DeclareVar (Name.Name \"_1_aChar\") (Type.Primitive (Primitive.Char)) (None)) (Statement.Assign (AssignLhs.Ident (Ident.Ident (Name.Name \"_1_aChar\"))) (Expression.Literal (Literal.CharLiteral \"a\"))) (Statement.DeclareVar (Name.Name \"_2_helloWorldString\") (Type.Primitive (Primitive.String)) (None)) (Statement.Assign (AssignLhs.Ident (Ident.Ident (Name.Name \"_2_helloWorldString\"))) (Expression.Literal (Literal.StringLiteral \"Hello World!\" false))) (Statement.Assign (AssignLhs.Ident (Ident.Ident (Name.Name \"max\"))) (Expression.Index (Expression.Ident (Name.Name \"values\")) (CollKind.Array) ((Expression.Literal (Literal.IntLiteral \"0\" (Type.Primitive (Primitive.Int))))))) (Statement.DeclareVar (Name.Name \"_3_idx\") (Type.Primitive (Primitive.Int)) (None)) (Statement.Assign (AssignLhs.Ident (Ident.Ident (Name.Name \"_3_idx\"))) (Expression.Literal (Literal.IntLiteral \"0\" (Type.Primitive (Primitive.Int))))) (Statement.While (Expression.BinOp (BinOp.Lt) (Expression.Ident (Name.Name \"_3_idx\")) (Expression.UnOp (UnaryOp.Cardinality) (Expression.IndexRange (Expression.Ident (Name.Name \"values\")) true (None) (None)))) ((Statement.If (Expression.BinOp (BinOp.Lt) (Expression.Ident (Name.Name \"max\")) (Expression.Index (Expression.Ident (Name.Name \"values\")) (CollKind.Array) ((Expression.Ident (Name.Name \"_3_idx\"))))) ((Statement.Assign (AssignLhs.Ident (Ident.Ident (Name.Name \"max\"))) (Expression.Index (Expression.Ident (Name.Name \"values\")) (CollKind.Array) ((Expression.Ident (Name.Name \"_3_idx\")))))) ()) (Statement.Assign (AssignLhs.Ident (Ident.Ident (Name.Name \"_3_idx\"))) (Expression.BinOp (BinOp.Plus) (Expression.Ident (Name.Name \"_3_idx\")) (Expression.Literal (Literal.IntLiteral \"1\" (Type.Primitive (Primitive.Int)))))))) (Statement.EarlyReturn)) ((Type.Primitive (Primitive.Int))) (Some ((Ident.Ident (Name.Name \"max\")))))) (ClassItem.Method (Method.Method true true (None) (Name.Name \"SayHello\") () ((Formal.Formal (Name.Name \"who\") (Type.Primitive (Primitive.String)) ())) ((Statement.Print (Expression.BinOp (BinOp.Concat) (Expression.BinOp (BinOp.Concat) (Expression.Literal (Literal.StringLiteral \"Hello \" false)) (Expression.Ident (Name.Name \"who\"))) (Expression.Literal (Literal.StringLiteral \" !\" false)))) (Statement.EarlyReturn)) () (Some ())))) ())))))))";

val maximum_sexp = (test0 ``sxnt_sexp``) maximum_string;

(*
 * Helpers
 *)

(* FIXME The way we handle Dafny's strings and chars is most likely wrong.
   For one, Dafny deals with UTF-16/Unicode, while simpleSexp only deals
   with ASCII.
   Additionally, it is not really clear what is/needs to be escaped on
   Dafny's side, such that in can be properly handled in HOL.

   For now, we escape " and \ on Dafny's side, followed by surrounding
   the string by ", such that it gets interpreted as SX_STR by the
   lexer/parser, and hope for the best.

   In the future, it would probably be better to actually encode the same
   character set as Dafny, which may need a new lexer/parser for S-Expressions,
   at which point the question of when and what to escape should be tackled. *)

(* sexp -> (string option) *)
Definition sxstr_to_str_def:
  (sxstr_to_str (SX_STR str) = return str) ∧
  (sxstr_to_str _ = fail)
End
...
Definition sxstr_to_ch_def:
  (sxstr_to_ch (SX_STR (c::rst)) = return c) ∧
  (sxstr_to_ch _ = fail)
End

(* sexp -> (num option) *)
Definition sxnum_to_num_def:
  (sxnum_to_num (SX_NUM n) = return n) ∧
  (sxnum_to_num _ = fail)
End

(* sexp -> (bool option) *)
Definition sxsym_to_bool_def:
  (sxsym_to_bool (SX_SYM str) =
...
Definition sexp_name_def:
  ...
  od
End
val test = EVAL “sexp_name (⟪SX_SYM "Name.Name"; SX_STR "T0"⟫)”;
val test = EVAL “sexp_name (⟪SX_SYM "Name. Name"; SX_STR "T0"⟫)”;
val test = EVAL “sexp_name (⟪SX_SYM "Name.Name"⟫)”;
...
Definition sexp_ident_def:
  ...
  od
End
val test = EVAL “sexp_ident (⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "T0"⟫ ⟫)”;
val test = EVAL “sexp_ident (⟪SX_SYM "Ident.Idet"; ⟪SX_SYM "Name.Name"; SX_STR "T0"⟫ ⟫)”;
val test = EVAL “sexp_ident (⟪SX_SYM "Ident.Ident"; ⟪SX_NUM 3⟫ ⟫)”;
...
Definition sexp_attribute_def:
  ...
  od
End
val test = EVAL “sexp_attribute (⟪SX_SYM "Attribute.Attribute"; SX_STR "axiom"; ⟪ ⟫ ⟫)”;
...
Definition sexp_primitive_def:
  ...
  od
End
val test = EVAL “sexp_primitive (⟪SX_SYM "Primitive.Int"⟫)”;
...
Definition sexp_collKind_def:
  ...
  od
End
val test = EVAL “sexp_collKind ⟪SX_SYM "CollKind.Array"⟫”;
val test = EVAL “sexp_collKind ⟪SX_SYM "CollKind.Vector"⟫”;
...
Definition sexp_typeArgDecl_def:
  ...
  od
End
val test = EVAL “sexp_typeArgDecl ⟪SX_SYM "TypeArgDecl.TypeArgDecl"; ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "T0"⟫ ⟫; ⟪ ⟫ ⟫”
...
Definition sexp_newtypeRange_def:
  ...
  od
End
val test = EVAL “sexp_newtypeRange ⟪SX_SYM "NewtypeRange.NoRange"⟫”;
...
Definition sexp_unaryOp_def:
  ...
  od
End
val test = EVAL “sexp_unaryOp ⟪SX_SYM "UnaryOp.Cardinality"⟫”;
...
Definition sexp_binOp_def:
  ...
  od
End
val test = EVAL “sexp_binOp ⟪SX_SYM "BinOp.Eq" ; SX_SYM "true" ; SX_SYM "false"⟫”;
val test = EVAL “sexp_binOp ⟪SX_SYM "BinOp.Lt"⟫”;
val test = EVAL “sexp_binOp ⟪SX_SYM "BinOp.Plus"⟫”;
val test = EVAL “sexp_binOp ⟪SX_SYM "BinOp.Lt" ; SX_SYM "true"⟫”;
...
Termination
  cheat
End
val test = EVAL “sexp_type ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫”;
val test = EVAL “sexp_type ⟪SX_SYM "Type.Array"; ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫; 1⟫”;
val test = EVAL “sexp_type ⟪SX_SYM "Type.TypeArg"; ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "T1"⟫ ⟫ ⟫”;
...
Definition sexp_literal_def:
  ...
  od
End
val test = EVAL “sexp_literal ⟪SX_SYM "Literal.IntLiteral"; SX_STR "0"; ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫ ⟫”;
val test = EVAL “sexp_literal ⟪SX_SYM "Literal.CharLiteral"; SX_STR "a"⟫”;
val test = EVAL “sexp_literal ⟪SX_SYM "Literal.StringLiteral"; SX_STR "Hello World!"; SX_SYM "false"⟫”;
...
Definition sexp_formal_def:
  ...
  od
End
val test = EVAL “sexp_formal ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "_0"⟫; ⟪SX_SYM "Type.TypeArg"; ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "T0"⟫ ⟫ ⟫; ⟪ ⟫ ⟫”;
val test = EVAL “sexp_formal ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "_1"⟫; ⟪SX_SYM "Type.TypeArg"; ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "T1"⟫ ⟫ ⟫; ⟪ ⟫ ⟫”;
val test = EVAL “sexp_formal ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "values"⟫; ⟪SX_SYM "Type.Array"; ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫; 1⟫; ⟪ ⟫ ⟫”;
...
Definition sexp_callSignature_def:
  ...
  od
End
val test = EVAL “sexp_callSignature ⟪SX_SYM "CallSignature.CallSignature";
         ⟪ ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "who"⟫;
         ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.String"⟫ ⟫; ⟪ ⟫ ⟫ ⟫ ⟫”;
...
Definition sexp_callName_def:
  ...
  od
End
val test = EVAL “sexp_callName ⟪SX_SYM "CallName.CallName";
         ⟪SX_SYM "Name.Name"; SX_STR "SayHello"⟫; ⟪SX_SYM "None"⟫;
         ⟪SX_SYM "CallSignature.CallSignature";
         ⟪ ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "who"⟫;
         ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.String"⟫ ⟫; ⟪ ⟫ ⟫ ⟫ ⟫ ⟫”;
...
val test = EVAL “sexp_statement ⟪SX_SYM "Statement.DeclareVar";
                 ⟪SX_SYM "Name.Name"; SX_STR "max"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫;
                 ⟪SX_SYM "Some";
                 ⟪SX_SYM "Expression.InitializationValue";
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫ ⟫ ⟫ ⟫”;
val test = EVAL “sexp_statement ⟪SX_SYM "Statement.Call";
                 ⟪SX_SYM "Expression.Companion";
                 ⟪ ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_module"⟫ ⟫;
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "__default"⟫ ⟫ ⟫ ⟫;
                 ⟪SX_SYM "CallName.CallName";
                 ⟪SX_SYM "Name.Name"; SX_STR "SayHello"⟫; ⟪SX_SYM "None"⟫;
                 ⟪SX_SYM "CallSignature.CallSignature";
                 ⟪ ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "who"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.String"⟫ ⟫; ⟪ ⟫ ⟫ ⟫ ⟫ ⟫;
                 ...
                 ⟪SX_SYM "Literal.StringLiteral"; SX_STR "CakeML"; SX_SYM "false"⟫ ⟫ ⟫;
                 ⟪SX_SYM "None"⟫ ⟫”;
val test = EVAL “sexp_statement ⟪SX_SYM "Statement.Assign";
                 ⟪SX_SYM "AssignLhs.Ident";
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_1_aChar"⟫ ⟫ ⟫;
                 ⟪SX_SYM "Expression.Literal";
                 ⟪SX_SYM "Literal.CharLiteral"; SX_STR "a"⟫ ⟫ ⟫” ;
val test = EVAL “sexp_statement ⟪SX_SYM "Statement.While";
                 ⟪SX_SYM "Expression.BinOp"; ⟪SX_SYM "BinOp.Lt"⟫;
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_3_idx"⟫ ⟫;
                 ⟪SX_SYM "Expression.UnOp"; ⟪SX_SYM "UnaryOp.Cardinality"⟫;
                 ⟪SX_SYM "Expression.IndexRange";
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "values"⟫ ⟫;
                 SX_SYM "true"; ⟪SX_SYM "None"⟫; ⟪SX_SYM "None"⟫ ⟫ ⟫ ⟫;
                 ⟪ ⟪SX_SYM "Statement.If";
                 ⟪SX_SYM "Expression.BinOp"; ⟪SX_SYM "BinOp.Lt"⟫;
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "max"⟫ ⟫;
                 ⟪SX_SYM "Expression.Index";
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "values"⟫ ⟫;
                 ⟪SX_SYM "CollKind.Array"⟫;
                 ⟪ ⟪SX_SYM "Expression.Ident";
                 ⟪SX_SYM "Name.Name"; SX_STR "_3_idx"⟫ ⟫ ⟫ ⟫ ⟫;
                 ⟪ ⟪SX_SYM "Statement.Assign";
                 ⟪SX_SYM "AssignLhs.Ident";
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "max"⟫ ⟫ ⟫;
                 ⟪SX_SYM "Expression.Index";
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "values"⟫ ⟫;
                 ⟪SX_SYM "CollKind.Array"⟫;
                 ⟪ ⟪SX_SYM "Expression.Ident";
                 ...
                 ⟪SX_SYM "Statement.Assign";
                 ⟪SX_SYM "AssignLhs.Ident";
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_3_idx"⟫ ⟫ ⟫;
                 ⟪SX_SYM "Expression.BinOp"; ⟪SX_SYM "BinOp.Plus"⟫;
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_3_idx"⟫ ⟫;
                 ⟪SX_SYM "Expression.Literal";
                 ⟪SX_SYM "Literal.IntLiteral"; SX_STR "1";
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫ ⟫ ⟫ ⟫ ⟫ ⟫ ⟫”;
val test = EVAL “sexp_statement ⟪SX_SYM "Statement.EarlyReturn"⟫”;
val test = EVAL “sexp_statement ⟪SX_SYM "Statement.Print";
                 ⟪SX_SYM "Expression.BinOp"; ⟪SX_SYM "BinOp.Concat"⟫;
                 ⟪SX_SYM "Expression.BinOp"; ⟪SX_SYM "BinOp.Concat"⟫;
                 ⟪SX_SYM "Expression.Literal";
                 ⟪SX_SYM "Literal.StringLiteral"; SX_STR "Hello "; SX_SYM "false"⟫ ⟫;
                 ⟪SX_SYM "Expression.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "who"⟫ ⟫ ⟫;
                 ⟪SX_SYM "Expression.Literal";
                 ⟪SX_SYM "Literal.StringLiteral"; SX_STR " !"; SX_SYM "false"⟫ ⟫ ⟫ ⟫”;
...
Definition sexp_method_def:
  ...
  od
End
val test = EVAL “sexp_method ⟪SX_SYM "Method.Method"; SX_SYM "true"; SX_SYM "true";
                 ⟪SX_SYM "None"⟫; ⟪SX_SYM "Name.Name"; SX_STR "SayHello"⟫; ⟪ ⟫;
                 ⟪ ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "who"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.String"⟫ ⟫; ⟪ ⟫ ⟫ ⟫;
                 ...
                 ⟪SX_SYM "Expression.Literal";
                 ⟪SX_SYM "Literal.StringLiteral"; SX_STR " !"; SX_SYM "false"⟫ ⟫ ⟫ ⟫;
                 ⟪SX_SYM "Statement.EarlyReturn"⟫ ⟫; ⟪ ⟫; ⟪SX_SYM "Some"; ⟪ ⟫ ⟫ ⟫”;
val test = EVAL “sexp_method ⟪SX_SYM "Method.Method"; SX_SYM "true"; SX_SYM "true";
                 ⟪SX_SYM "None"⟫; ⟪SX_SYM "Name.Name"; SX_STR "Maximum"⟫; ⟪ ⟫;
                 ⟪ ⟪SX_SYM "Formal.Formal"; ⟪SX_SYM "Name.Name"; SX_STR "values"⟫;
                 ⟪SX_SYM "Type.Array";
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫; 1⟫; ⟪ ⟫ ⟫ ⟫;
                 ⟪ ⟪SX_SYM "Statement.DeclareVar";
                 ⟪SX_SYM "Name.Name"; SX_STR "max"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫;
                 ⟪SX_SYM "Some";
                 ⟪SX_SYM "Expression.InitializationValue";
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫ ⟫ ⟫ ⟫;
                 ⟪SX_SYM "Statement.Call";
                 ⟪SX_SYM "Expression.Companion";
                 ⟪ ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_module"⟫ ⟫;
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "__default"⟫ ⟫ ⟫ ⟫;
                 ⟪SX_SYM "CallName.CallName";
                 ...
                 ⟪SX_SYM "None"⟫ ⟫;
                 ⟪SX_SYM "Statement.DeclareVar";
                 ⟪SX_SYM "Name.Name"; SX_STR "_1_aChar"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Char"⟫ ⟫;
                 ⟪SX_SYM "None"⟫ ⟫;
                 ⟪SX_SYM "Statement.Assign";
                 ⟪SX_SYM "AssignLhs.Ident";
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_1_aChar"⟫ ⟫ ⟫;
                 ...
                 ⟪SX_SYM "Literal.CharLiteral"; SX_STR "a"⟫ ⟫ ⟫;
                 ⟪SX_SYM "Statement.DeclareVar";
                 ⟪SX_SYM "Name.Name"; SX_STR "_2_helloWorldString"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.String"⟫ ⟫;
                 ⟪SX_SYM "None"⟫ ⟫;
                 ⟪SX_SYM "Statement.Assign";
                 ⟪SX_SYM "AssignLhs.Ident";
                 ...
                 ⟪SX_SYM "CollKind.Array"⟫;
                 ⟪ ⟪SX_SYM "Expression.Literal";
                 ⟪SX_SYM "Literal.IntLiteral"; SX_STR "0";
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫ ⟫ ⟫ ⟫ ⟫ ⟫;
                 ⟪SX_SYM "Statement.DeclareVar";
                 ⟪SX_SYM "Name.Name"; SX_STR "_3_idx"⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫;
...
Definition sexp_classItem_def:
  ...
  od
End
val test = EVAL “sexp_classItem ⟪SX_SYM "ClassItem.Method";
...
Definition sexp_class_def:
  ...
  od
End
val test = EVAL “sexp_class ⟪SX_SYM "Class.Class"; ⟪SX_SYM "Name.Name"; SX_STR "__default"⟫;
                 ⟪SX_SYM "Ident.Ident"; ⟪SX_SYM "Name.Name"; SX_STR "_module"⟫ ⟫;
                 ⟪ ⟫; ⟪ ⟫; ⟪ ⟫;
...
Definition sexp_newtype_def:
  ...
  od
End
val test = EVAL “sexp_newtype ⟪SX_SYM "Newtype.Newtype"; ⟪SX_SYM "Name.Name"; SX_STR "nat"⟫; ⟪ ⟫;
                 ⟪SX_SYM "Type.Primitive"; ⟪SX_SYM "Primitive.Int"⟫ ⟫;
...
Definition sexp_datatypeDtor_def:
  ...
  od
End
val test = EVAL “sexp_datatypeDtor ⟪SX_SYM "DatatypeDtor.DatatypeDtor";
...
Definition sexp_datatypeCtor_def:
  ...
  od
End
val test = EVAL “sexp_datatypeCtor ⟪SX_SYM "DatatypeCtor.DatatypeCtor";
