  ...
  Cases_on`vs`>>fs[]>>Cases_on`op`>>fs[]>-(
    ...
    Cases_on`t'`>>fs[]>-(
      ...
      >-(
        BasicProvers.EVERY_CASE_TAC>>fs[]>>rw[]>>
        fs[semanticPrimitivesTheory.store_alloc_def]>>
        rw[prim_exn_exh_def,prim_exn_pat_def, map_replicate])
      >-(
        Cases_on`h'`>>fs[]>>
        Cases_on`l`>>fs[]>>
        Cases_on`h`>>fs[]>>
...
val do_app_pat_v_pat = store_thm("do_app_pat_v_pat",
  ...
  Cases_on`do_app_pat s op vs`>>rw[]>-(
    ...
    Cases_on`xs`>>fs[] >- (
      ...
      Cases_on`o''`>>fs[]
      >- (BasicProvers.EVERY_CASE_TAC >>
          fs [LET_THM, semanticPrimitivesTheory.store_alloc_def])
      >- (BasicProvers.EVERY_CASE_TAC >>
          fs [LET_THM, semanticPrimitivesTheory.store_alloc_def])
      >- (
      ...
      >- (BasicProvers.EVERY_CASE_TAC >>
          fs [LET_THM, semanticPrimitivesTheory.store_alloc_def])
      >- (BasicProvers.EVERY_CASE_TAC >>
          fs [LET_THM, semanticPrimitivesTheory.store_lookup_def] >>
          imp_res_tac LIST_REL_LENGTH >> fs[] >>
          rw [] >>
          fs[LIST_REL_EL_EQN] >>
