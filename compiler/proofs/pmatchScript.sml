...
open LibTheory SemanticPrimitivesTheory terminationTheory miscTheory semanticsExtraTheory CompilerLibTheory IntLangTheory ToIntLangTheory compilerTerminationTheory intLangTheory
...
val Cevaluate_match_remove_mat_var = store_thm("Cevaluate_match_remove_mat_var",
  ...
  qsuff_tac`
    ...
    qmatch_abbrev_tac`(P ⇒ Q) ⇒ R` >>
    qsuff_tac`P` >- metis_tac[result_rel_syneq_trans,EVERY2_syneq_trans] >>
    map_every qunabbrev_tac[`P`,`Q`,`R`] >>
