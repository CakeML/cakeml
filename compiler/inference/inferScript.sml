...
(* TODO: implement mutually recursive translations *)
...
val infer_p_ind = DB.fetch "-" "infer_p_ind";
...
(* TODO : update that to wrap up the monadic translation *)
...
(* Do a case on the optional specs? *)
