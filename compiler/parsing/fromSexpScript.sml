...
val sexpop_def = Define`
  ...
  if s = "W8fromInt" then SOME W8fromInt else
  if s = "W8toInt" then SOME W8toInt else
...
val opsexp_def = Define`
  ...
  (opsexp W8fromInt = SX_SYM "W8fromInt") ∧
  (opsexp W8toInt = SX_SYM "W8toInt") ∧
