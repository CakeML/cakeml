...
val sexpdec_alt_def = tDefine"sexpdec_alt"`
  (sexpdec_alt s =
    ...
    | SOME (nm,args) =>
      ...
      else if nm = "Dlocal" ∧ LENGTH args = 2  then
            (lift2 Dlocal (sexpdec_list (EL 0 args))
                        (sexpdec_list (EL 1 args)))
      else NONE) ∧
   (sexpdec_list s =
      case s of
      | SX_SYM nm => if nm = "nil" then SOME [] else NONE
...
Theorem sexpspec_specsexp[simp]:
