...
Theorem v2n_11:
   !v1 v2. LENGTH v1 = LENGTH v2 ==> (v2n v1 = v2n v2 <=> v1 = v2)
Proof
   cheat
QED
...
Theorem v2n_longer_fixwidth:
   !x n. n < 2 ** x ==> fixwidth x (n2v n) = n2v n
Proof
  cheat
QED
...
Proof
  ...
  \\ Cases_on`e1` \\ fs[odestSXNUM_def,v2n_longer_fixwidth]
