...
val _ = Define `
 (get_tagenv ((next,tagenv,inv12882),acc) = tagenv)`;
...
val _ = Define `
 (alloc_tag tn cn ((next,tagenv,inv12883),acc) =
  (((next+ 1),insert_tag_env cn (next,SOME tn) tagenv,inv12883 |+ (next, (cn,tn))),acc |+ (cn, (next,SOME tn))))`;
