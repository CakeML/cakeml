...
(! c s env n.
 n IN( FDOM  env)
==>
Cevaluate c s env ((CVar n)) (s,( Rval (((FAPPLY  env)  n)))))
...
Cevaluate c) s') (((FUPDATE  env) ( n, v)))) b) r)
==>
...
Cevaluate c) s)
  ...
  b) r)
==>
Cevaluate c s env (((((CLetfun F) ns) defs) b)) r)
...
Cevaluate c) s)
  ...
  b) r)
==>
Cevaluate c s env (((((CLetfun T) ns) defs) b)) r)
