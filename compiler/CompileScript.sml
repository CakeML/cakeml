...
open alistTheory state_transformerTheory; val _ = intLib.deprecate_int();
...
val _ = Hol_datatype `
 Cexp =
  ...
  | CProj of Cexp => num
  | CLet of Cexp => Cexp
  | CLetrec of (num # ( Cexp + num)) list => Cexp
  | CFun of num => ( Cexp + num)
...
val _ = type_abbrev( "def" , ``: num # ( Cexp + num)``);
