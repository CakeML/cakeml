...
val arm8_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=2; len_size:=16; has_div:=F|>``
...
val arm_data_conf = ``<| tag_bits:=0; len_bits:=0; pad_bits:=1; len_size:=16; has_div:=F|>``
...
val mips_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=2; len_size:=16; has_div:=F|>``
...
val riscv_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=2; len_size:=16; has_div:=F|>``
...
val x64_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=2; len_size:=16; has_div:=T|>``
