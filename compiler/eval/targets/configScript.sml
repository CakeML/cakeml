...
val arm8_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=0; len_size:=16|>``
...
val arm_data_conf = ``<| tag_bits:=0; len_bits:=0; pad_bits:=0; len_size:=8|>``
...
val mips_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=0; len_size:=16|>``
...
val riscv_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=0; len_size:=16|>``
...
val x64_data_conf = ``<| tag_bits:=4; len_bits:=4; pad_bits:=0; len_size:=16|>``
