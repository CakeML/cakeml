...
Theorem do_opapp_thm:
  ...
  ==>
  ?i sg exp' env2 cfg. compile_exps cfg [exp] = (i, sg, [exp']) /\
...
Proof
  ...
  >- (
    ...
    >- (
      ...
      \\ impl_tac >- (fs [env_rel_def] \\ CCONTR_TAC \\ fs [])
      \\ rw []
  ...
  >- (
    ...
    \\ imp_res_tac state_rel_IMP_c
    \\ fs [compile_dec_def, prev_cfg_rel_refl]
    \\ rveq \\ fs []
    \\ simp [evaluate_def]
