...
(* IS_SUBLIST_MEM, IS_SUBLIST_APPEND1, IS_SUBLIST_APPEND2, IS_SUBLIST_REFL,
   map2_snoc, el_map2, length_take2, el_take_append, el_append2,
   el_append2_lemma, hd_append, tl_append moved to listLemmasTheory *)
