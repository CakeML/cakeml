 ...
 >- (
  ...
  \\ conj_tac >- (
    ...
    \\ `(~(IS_SOME loco /\
          ...
          pure x1) ==> env_rel (v_rel g1 l1) env env2 0 (MAP (λx. (0,x)) e1))`
  ...
  \\ first_x_assum(qspecl_then[`g1`,`l1`]mp_tac o
        CONV_RULE(RESORT_FORALL_CONV List.rev))
  \\ `EVERY (wfv g1 l1) args /\ EVERY (wfv g1 l1) rest1` by
