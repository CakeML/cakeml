...
val dest_closure_wfv = Q.store_thm("dest_closure_wfv",
...
val calls_correct = Q.store_thm("calls_correct",
  ...
  \\ conj_tac >- (
    ...
    >- (
      ...
      by (
        ...
        \\ simp[] )
      \\ rfs[]
      \\ qpat_assum`code_includes (SND g) _`assume_tac
  ...
  >- (
    ...
    >- (
      every_case_tac \\ fs[] \\ rveq \\ fs[]
      \\ match_mp_tac (GEN_ALL dest_closure_wfv)
      \\ asm_exists_tac \\ fs[] )
    \\ conj_asm1_tac
    >- (
      every_case_tac \\ fs[] \\ rveq \\ fs[]
