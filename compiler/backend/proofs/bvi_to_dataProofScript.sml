...
Resume compile_correct[Call]:
  ...
  THEN1 (full_simp_tac(srw_ss())[get_var_def,lookup_insert,call_env_def,flush_state_def,data_to_bvi_result_def])
  >- (IMP_RES_TAC compile_LESS_EQ
  \\ IMP_RES_TAC compile_SING_IMP
