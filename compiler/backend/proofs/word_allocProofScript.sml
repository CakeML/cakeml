      ...
      >- (
        ...
        impl_tac>- (
          ...
          >-
            ...
            rev_full_simp_tac(srw_ss())[])
          >- (
            full_simp_tac(srw_ss())[Abbr`ls`,set_toAList_keys,domain_union,SUBSET_DEF,EXTENSION]>>
            metis_tac[])
          >-
    ...
    >- ( (*Excepting with handler*)
      ...
      impl_tac>- (
        ...
        >-
          ...
          rev_full_simp_tac(srw_ss())[])
        >-
          full_simp_tac(srw_ss())[domain_fromAList,set_toAList_keys,domain_union]
        >-
