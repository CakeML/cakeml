...
Theorem all_ts_SUBSET_list_to_v_alt:
  !refs t xs stack ts.
    all_ts refs (t::(xs ++ stack)) ⊆
    all_ts refs (list_to_v_alt ts t xs::stack)
Proof
  Induct_on `xs` \\ fs [list_to_v_alt_def,all_ts_cons] \\ rw []
...
Theorem new_all_ts_SUBSET_list_to_v_alt:
  !refs t xs stack ts.
