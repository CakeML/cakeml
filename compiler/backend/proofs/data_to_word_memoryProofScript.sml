...
val word_copy_array_thm = store_thm("word_copy_array_thm",
  ``!n xp yp xs ys ys1 m.
...
val last_bytes_0 = store_thm("last_bytes_0",
...
val LUPDATE_REPLICATE = store_thm("LUPDATE_REPLICATE[simp]",
...
val memory_rel_copy_array_NONE = store_thm("memory_rel_copy_array_NONE",
...
val v_inv_walk_LENGTH = Q.store_thm("v_inv_walk_LENGTH",
  `!vs ptr ps.
...
val BlockRep_heap_length = Q.store_thm("BlockRep_heap_length[simp]",
  `heap_length [BlockRep tag [x;y]] = 3`, EVAL_TAC);

val ALL_DISTINCT_FILTER_LENGTH = Q.store_thm("ALL_DISTINCT_FILTER_LENGTH",
  `ALL_DISTINCT xs
   ==>
...
val list_to_v_heap_length = Q.store_thm("list_to_v_heap_length",
  ...
  metis_tac [v_inv_list_to_v_EVERY, heap_length_Blocks,
             v_inv_walk_LENGTH, v_inv_walk_ALL_DISTINCT,
             v_inv_ok, ok_def, v_inv_list_to_v_lemma]);
