...
val bytes_in_large_word_def = Define`bytes_in_large_word (wl:bool list)
                               = (if ROUNDUP_DIV (LENGTH wl) 8 > w2n (word_T:'a word) then NONE  else SOME (n2w (ROUNDUP_DIV (LENGTH wl) 8))):(('a word) option)`
