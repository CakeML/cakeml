...
(* ASK: There are issues with using list_to_v_alt as input for
        v_inv since the vs' created always have 0 timestamps
*)
...
(*           f, tf, ha ++ hm ++ heap_expand (sp - heap_length hm) ++ hb)`, *)
