...
val set_var_set_var = store_thm("set_var_set_var[simp]",
  ...
  full_simp_tac(srw_ss())[wordSemTheory.state_component_equality,wordSemTheory.set_var_def,
      insert_shadow]);
...
val MEM_FIRST_EL = prove(
  ...
  THEN1 (srw_tac[][] \\ qexists_tac `LEAST n. EL n xs = x /\ n < LENGTH xs`
    ...
    \\ full_simp_tac(srw_ss())[MEM_EL] \\ strip_tac \\ pop_assum (qspec_then `n` mp_tac)
    \\ full_simp_tac(srw_ss())[] \\ srw_tac[][] \\ imp_res_tac LESS_LEAST \\ full_simp_tac(srw_ss())[] \\ `F` by decide_tac)
  \\ srw_tac[][] \\ full_simp_tac(srw_ss())[MEM_EL] \\ qexists_tac `n` \\ full_simp_tac(srw_ss())[]);
...
val ALOOKUP_ZIP_EL = prove(
  ...
  Induct \\ Cases_on `hs` \\ full_simp_tac(srw_ss())[] \\ Cases_on `n` \\ full_simp_tac(srw_ss())[]
  \\ rpt strip_tac \\ first_assum (qspec_then `0` assume_tac) \\ full_simp_tac(srw_ss())[]
  \\ srw_tac[][] \\ first_x_assum match_mp_tac \\ full_simp_tac(srw_ss())[] \\ srw_tac[][]
...
val ALOOKUP_SKIP_LEMMA = prove(
  ...
  full_simp_tac(srw_ss())[ALOOKUP_APPEND] \\ full_simp_tac(srw_ss())[GSYM ALOOKUP_NONE])
...
val PERM_list_rearrange = prove(
  ...
  srw_tac[][] \\ match_mp_tac PERM_ALL_DISTINCT \\ full_simp_tac(srw_ss())[mem_list_rearrange]
...
val ALL_DISTINCT_MEM_IMP_ALOOKUP_SOME = prove(
  ...
  Induct \\ full_simp_tac(srw_ss())[] \\ Cases \\ full_simp_tac(srw_ss())[ALOOKUP_def] \\ srw_tac[][]
  \\ res_tac \\ full_simp_tac(srw_ss())[MEM_MAP,FORALL_PROD] \\ rev_full_simp_tac(srw_ss())[]) |> SPEC_ALL;
...
val EVERY2_IMP_EL = prove(
  ...
  Induct \\ Cases_on `ys` \\ full_simp_tac(srw_ss())[] \\ srw_tac[][] \\ Cases_on `n` \\ full_simp_tac(srw_ss())[]);
...
val EVERY2_APPEND_IMP = prove(
  ...
  Induct \\ full_simp_tac(srw_ss())[] \\ srw_tac[][] \\ res_tac \\ full_simp_tac(srw_ss())[]
...
val word_ml_inv_rearrange = prove(
  ...
  \\ srw_tac[][] \\ res_tac
  \\ `MEM p_1 (MAP FST xs)` by (full_simp_tac(srw_ss())[MEM_MAP,EXISTS_PROD] \\ metis_tac [])
...
val word_gc_move_loop_eq = store_thm("word_gc_move_loop_eq",
  ...
  \\ full_simp_tac(srw_ss())[GSYM word_gc_move_loop_def]
...
val word_heap_APPEND = prove(
  ...
  Induct \\ full_simp_tac(srw_ss())[word_heap_def,heap_length_def,SEP_CLAUSES,STAR_ASSOC]
...
val word_payload_T_IMP = prove(
  ...
  Cases_on `tag` \\ full_simp_tac(srw_ss())[word_payload_def] \\ srw_tac[][] \\ full_simp_tac(srw_ss())[LENGTH_NIL]
  \\ full_simp_tac(srw_ss())[word_or_def,fcpTheory.FCP_BETA,word_lsl_def,wordsTheory.word_index]);
...
val word_gc_move_loop_thm = prove(
  ...
  THEN1
   (full_simp_tac(srw_ss())[gc_move_loop_def] \\ rpt var_eq_tac \\ full_simp_tac(srw_ss())[]
    \\ pop_assum mp_tac \\ once_rewrite_tac [word_gc_move_loop_eq] \\ full_simp_tac(srw_ss())[]
    \\ strip_tac \\ rpt var_eq_tac \\ full_simp_tac(srw_ss())[]
  ...
  \\ Cases_on `h5` \\ full_simp_tac(srw_ss())[] \\ rpt var_eq_tac \\ full_simp_tac(srw_ss())[]
  ...
  \\ IF_CASES_TAC THEN1
   (`F` by all_tac
    ...
    \\ pop_assum mp_tac
    \\ Q.PAT_ABBREV_TAC `x = bytes_in_word * n2w (SUM (MAP el_length h1))` \\ full_simp_tac(srw_ss())[]
    ...
    \\ full_simp_tac(srw_ss())[NOT_LESS] \\ full_simp_tac(srw_ss())[GSYM heap_length_def]
    ...
    \\ full_simp_tac(srw_ss())[] \\ rev_full_simp_tac(srw_ss())[good_dimindex_def,dimword_def]
    \\ rev_full_simp_tac(srw_ss())[good_dimindex_def,dimword_def] \\ decide_tac)
  \\ Cases_on `b5`
  \\ full_simp_tac(srw_ss())[word_heap_APPEND,word_heap_def,SEP_CLAUSES,STAR_ASSOC,word_el_def]
  ...
  \\ full_simp_tac(srw_ss())[isWord_def,theWord_def] \\ rev_full_simp_tac(srw_ss())[]
  \\ qcase_tac `word_payload _ _ tag _ conf = _`
  \\ drule word_payload_T_IMP
  \\ Cases_on `h ' 0` \\ full_simp_tac(srw_ss())[] \\ strip_tac \\ full_simp_tac(srw_ss())[]
  THEN1
   (full_simp_tac(srw_ss())[gc_move_list_def] \\ rpt var_eq_tac \\ full_simp_tac(srw_ss())[]
...
val word_list_exists_thm = store_thm("word_list_exists_thm",
  ...
  full_simp_tac(srw_ss())[word_heap_def,word_list_exists_def,LENGTH_NIL,FUN_EQ_THM,ADD1,
          SEP_EXISTS_THM,cond_STAR,word_list_def,word_el_def,SEP_CLAUSES]
  \\ srw_tac[][] \\ eq_tac \\ srw_tac[][]
  THEN1
   (Cases_on `xs` \\ full_simp_tac(srw_ss())[ADD1] \\ full_simp_tac(srw_ss())[word_list_def]
    \\ qexists_tac `h` \\ full_simp_tac(srw_ss())[]
    \\ qexists_tac `t` \\ full_simp_tac(srw_ss())[SEP_CLAUSES])
  \\ qexists_tac `w::xs` \\ full_simp_tac(srw_ss())[word_list_def,ADD1,STAR_ASSOC,cond_STAR]);
...
val word_list_exists_ADD = store_thm("word_list_exists_ADD",
  ...
  \\ full_simp_tac(srw_ss())[STAR_ASSOC,ADD1,GSYM word_add_n2w,WORD_LEFT_ADD_DISTRIB]);

val word_el_IMP_word_list_exists = prove(
  ``!temp p curr.
      (p * word_el curr temp conf) s ==>
      (p * word_list_exists curr (el_length temp)) s``,
  Cases \\ full_simp_tac(srw_ss())[word_el_def,el_length_def,GSYM ADD1,word_list_exists_thm]
  THEN1 (full_simp_tac(srw_ss())[SEP_CLAUSES,SEP_EXISTS_THM] \\ metis_tac [])
  \\ Cases_on `b`
  \\ full_simp_tac(srw_ss())[word_el_def,el_length_def,GSYM ADD1,word_list_exists_thm,LET_THM]
  \\ srw_tac[][] \\ split_pair_tac \\ full_simp_tac(srw_ss())[]
  \\ full_simp_tac (std_ss++sep_cond_ss) [cond_STAR]
  \\ srw_tac[][] \\ full_simp_tac(srw_ss())[word_list_def,SEP_CLAUSES,SEP_EXISTS_THM,word_list_exists_def]
  \\ full_simp_tac (std_ss++sep_cond_ss) [cond_STAR]
  \\ imp_res_tac word_payload_T_IMP \\ full_simp_tac(srw_ss())[] \\ srw_tac[][]
  \\ full_simp_tac(srw_ss())[STAR_ASSOC] \\ metis_tac []);

val word_heap_IMP_word_list_exists = prove(
  ``!temp p curr.
      (p * word_heap curr temp conf) s ==>
      (p * word_list_exists curr (heap_length temp)) s``,
  Induct \\ full_simp_tac(srw_ss())[heap_length_def,word_heap_def,word_list_exists_thm]
...
val word_full_gc_thm = prove(
  ...
  \\ full_simp_tac(srw_ss())[word_list_exists_def,SEP_CLAUSES,SEP_EXISTS_THM,word_heap_heap_expand]
  \\ full_simp_tac (std_ss++sep_cond_ss) [cond_STAR]
...
val word_gc_fun_lemma = prove(
  ...
  \\ full_simp_tac(srw_ss())[SEP_CLAUSES]
  \\ discharge_hyps
  THEN1 (imp_res_tac full_gc_IMP \\ full_simp_tac(srw_ss())[])
  \\ strip_tac \\ rpt var_eq_tac \\ full_simp_tac(srw_ss())[]
...
val assign_thm = Q.prove(
  ...
  \\ TRY (
    ...
    \\ cheat (* need more info about data refinement *))
  \\ TRY (
...
val gc_lemma = prove(
  ...
  \\ imp_res_tac (state_rel_call_env_push_env
      ...
      |> SIMP_RULE (srw_ss()) [dec_clock_inc_clock] |> DISCH_ALL) \\ full_simp_tac(srw_ss())[]
...
val word_ml_inv_SP_LIMIT = prove(
  ...
  \\ full_simp_tac(srw_ss())[word_ml_inv_def,abs_ml_inv_def,heap_ok_def,unused_space_inv_def]
  \\ imp_res_tac heap_lookup_SPLIT \\ srw_tac[][]
  \\ full_simp_tac(srw_ss())[heap_length_APPEND,heap_length_def,el_length_def] \\ decide_tac);
...
val has_space_state_rel = prove(
  ...
  full_simp_tac(srw_ss())[state_rel_def] \\ srw_tac[][] \\ asm_exists_tac \\ full_simp_tac(srw_ss())[]
  ...
  \\ full_simp_tac(srw_ss())[good_dimindex_def] \\ full_simp_tac(srw_ss())[w2n_minus1] \\ rev_full_simp_tac(srw_ss())[]
  \\ `F` by decide_tac);

val evaluate_IMP_inc_clock = prove(
  ``evaluate (q,t) = (NONE,t1) ==>
    evaluate (q,inc_clock ck t) = (NONE,inc_clock ck t1)``,
  srw_tac[][inc_clock_def] \\ match_mp_tac evaluate_add_clock \\ full_simp_tac(srw_ss())[]);
...
val compile_correct = store_thm("compile_correct",
  ...
  THEN1 (* MakeSpace *)
   (full_simp_tac(srw_ss())[comp_def,bvpSemTheory.evaluate_def,wordSemTheory.evaluate_def,
    ...
    \\ srw_tac[][] \\ full_simp_tac(srw_ss())[add_space_def,wordSemTheory.word_exp_def,
    ...
    \\ Cases_on `(alloc (alloc_size k) (adjust_set names)
         (t with locals := insert 1 (Word (alloc_size k)) t.locals))
             :('a result option)#( ('a,'ffi) wordSem$state)` \\ full_simp_tac(srw_ss())[]
    \\ full_simp_tac(srw_ss())[wordSemTheory.alloc_def,LET_DEF]
    \\ Q.ABBREV_TAC `t5 = (set_store AllocSize (Word (alloc_size k))
                 (t with locals := insert 1 (Word (alloc_size k)) t.locals))`
    \\ imp_res_tac cut_env_IMP_cut_env \\ full_simp_tac(srw_ss())[cut_env_adjust_set_insert_1]
    ...
    \\ `FLOOKUP t5.store AllocSize = SOME (Word (alloc_size k)) /\
     ...
     (UNABBREV_ALL_TAC \\ full_simp_tac(srw_ss())[state_rel_set_store_AllocSize]
      \\ full_simp_tac(srw_ss())[cut_env_adjust_set_insert_1,wordSemTheory.set_store_def]
      \\ srw_tac[][] \\ full_simp_tac(srw_ss())[SUBSET_DEF,state_rel_insert_1,FLOOKUP_DEF])
    \\ strip_tac
    ...
    \\ `IS_SOME (has_space (Word (alloc_size k):'a word_loc) t2)` by
      full_simp_tac(srw_ss())[wordSemTheory.has_space_def,state_rel_def,heap_in_memory_store_def]
    \\ Cases_on `has_space (Word (alloc_size k):'a word_loc) t2` \\ full_simp_tac(srw_ss())[]
    ...
    \\ UNABBREV_ALL_TAC \\ full_simp_tac(srw_ss())[wordSemTheory.set_store_def,state_rel_def])
  THEN1 (* Raise *)
   (full_simp_tac(srw_ss())[comp_def,bvpSemTheory.evaluate_def,wordSemTheory.evaluate_def]
