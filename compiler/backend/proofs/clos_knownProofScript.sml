...
val state_rel_co_elist_globals = Q.store_thm("state_rel_co_elist_globals",
     ...
     ((* inlD_LetInline *)
      ...
      THEN1
       ((* not pure *)
        ...
        \\ `state_oracle_mglobals_disjoint s2` by cheat
