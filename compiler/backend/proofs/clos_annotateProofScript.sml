...
`exp_rel (: 'ffi) [Fn loc NONE num_args e]
 ...
 >- (
   ...
   Cases_on `free [e]` >>
   fs [] >>
   qspec_then `[e]` assume_tac free_thm >>
   rfs [] >>
   fs [LET_THM]

   `!n. fv_set [e] n ⇔ has_var n r` by metis_tac [free_thm, LET_DEF]
 ...
 rw [dest_closure_def, check_loc_def, exec_rel_rw]
 >- cheat
 >- (
   simp [evaluate_ev_def] >>
   every_case_tac >>
   simp [res_rel_rw] >>
