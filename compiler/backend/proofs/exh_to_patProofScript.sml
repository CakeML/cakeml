...
val sIf_correct = store_thm("sIf_correct",
  ...
  full_simp_tac(srw_ss())[patSemTheory.Boolv_def,prim_tagsTheory.true_tag_def,prim_tagsTheory.false_tag_def])
