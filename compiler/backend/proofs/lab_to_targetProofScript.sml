...
Proof
  ...
  gvs[])
  >- irule $ SRULE[] o Q.SPEC `[]` $ GEN_ALL FILTER_mmio_pcs_min_index >>
  qspec_then `ffis` assume_tac $ SRULE[] o Q.SPEC `[]` $ GEN_ALL FILTER_mmio_pcs_min_index >>
  gvs[GSYM FILTER_EQ_ID]
QED
