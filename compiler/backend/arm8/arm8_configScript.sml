...
val arm8_stack_conf = ``<|jump:=F;reg_names:=arm8_names;perf_calls:=F|>``
val arm8_lab_conf = ``<|pos:=0;ffi_names:=NONE;labels:=LN;sec_pos_len:=[];init_clock:=5;hash_size:=104729n;shmem_extra:=[]|>``
