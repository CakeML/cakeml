...
val fp_upd_def = Define `
  ...
  (fp_upd (FPFma d1 d2 d3 d4) s =
     upd_fp_reg d1
       (fp64_mul_add roundTiesToEven (read_fp_reg d2 s) (read_fp_reg d3 s) (read_fp_reg d4 s)) s) /\
  (fp_upd (FPFms d1 d2 d3 d4) s =
     upd_fp_reg d1
       (fp64_mul_sub roundTiesToEven (read_fp_reg d2 s) (read_fp_reg d3 s) (read_fp_reg d4 s)) s) /\
