...
Definition inst_arg_convention_def:
  (inst_arg_convention is_x64 (Arith (AddCarry r1 r2 r3 r4)) ⇔ r4 = 0) ∧
  (* Note: forcing r4 = 0 not necessary *)
  (inst_arg_convention is_x64 (Arith (AddOverflow r1 r2 r3 r4)) ⇔ r4 = 0) ∧
  (* Note: forcing r4 = 0 not necessary *)
  (inst_arg_convention is_x64 (Arith (SubOverflow r1 r2 r3 r4)) ⇔ r4 = 0) ∧
  (* Note: forcing r2 = 0 not necessary *)
  (inst_arg_convention is_x64 (Arith (LongMul r1 r2 r3 r4)) ⇔ r2 = 0 ∧
    (is_x64 ⇒ r1 = 6 ∧ r3 = 0 ∧ r4 = 4)) ∧
  (* LongDiv follows conventions for x86 as it is the only possibility *)
  (inst_arg_convention is_x64 (Arith (LongDiv r1 r2 r3 r4 r5)) ⇔ r1 = 0 ∧ r2 = 6 ∧ r3 = 6 ∧ r4 = 0) ∧
  (inst_arg_convention _ _ = T)
End

(* Syntactic conventions for allocator *)
Definition call_arg_convention_def:
  (call_arg_convention is_x64 (Inst i) =
    inst_arg_convention is_x64 i) ∧
  (call_arg_convention is_x64 (Return x y) = (y=2)) ∧
  (call_arg_convention is_x64 (Raise y) = (y=2)) ∧
  (call_arg_convention is_x64 (Install ptr len _ _ _) = (ptr = 2 ∧ len = 4)) ∧
  (call_arg_convention is_x64 (FFI x ptr len ptr2 len2 args) = (ptr = 2 ∧ len = 4 ∧
                                                         ptr2 = 6 ∧ len2 = 8)) ∧
  (call_arg_convention is_x64 (Alloc n s) = (n=2)) ∧
  (call_arg_convention is_x64 (StoreConsts a b c d ws) =
    ((a=0) ∧ (b=2) ∧ (c=4) ∧ (d=6))) ∧
  (call_arg_convention is_x64 (Call ret dest args h) =
    (case ret of
      NONE => args = GENLIST (\x.2*x) (LENGTH args)
    | SOME (v,cutset,ret_handler,l1,l2) =>
      args = GENLIST (\x.2*(x+1)) (LENGTH args) ∧
      (v = 2) ∧ call_arg_convention is_x64 ret_handler ∧
    (case h of  (*Does not check the case where Calls are ill-formed*)
      NONE => T
    | SOME (v,prog,l1,l2) =>
      (v = 2) ∧ call_arg_convention is_x64 prog))) ∧
  (call_arg_convention is_x64 (MustTerminate s1) =
    call_arg_convention is_x64 s1) ∧
  (call_arg_convention is_x64 (Seq s1 s2) =
    (call_arg_convention is_x64 s1 ∧ call_arg_convention is_x64 s2)) ∧
  (call_arg_convention is_x64 (If cmp r1 ri e2 e3) =
    (call_arg_convention is_x64 e2 ∧
     call_arg_convention is_x64 e3)) ∧
  (call_arg_convention is_x64 p = T)
End
