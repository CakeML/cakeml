...
Proof
  rw [ do_app_aux_def,case_eq_thms
     , do_install_def,do_space_def,with_fresh_ts_def
     , PULL_EXISTS, UNCURRY,consume_space_def, check_lim_def] \\ fs []
...
val do_app_swap_tac =
   Cases \\ rw [do_app_def,do_stack_def,do_ffi_data_def
              , do_install_def
              , do_app_aux_def
              , with_fresh_ts_def
              , do_space_def
...
Proof
  ...
  Cases_on `op` >>
  ntac 2 (fs [do_app_aux_def,list_case_eq,option_case_eq,v_case_eq,
              bool_case_eq,do_ffi_data_def,ffiTheory.call_FFI_def,stack_consumed_def,
...
Proof
  rw[do_app_def,do_stack_def,do_space_def,do_app_aux_def,do_install_def,with_fresh_ts_def,do_ffi_data_def,
     check_lim_def,
