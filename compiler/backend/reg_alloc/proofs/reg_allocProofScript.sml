...
val undir_g_insert_domain = store_thm("undir_g_insert_domain",``
...
val is_subgraph_refl = store_thm("is_subgraph_refl",``is_subgraph G G``, fs[is_subgraph_def])

val is_subgraph_trans = store_thm("is_subgraph_trans",``
  is_subgraph A B ∧ is_subgraph B C ⇒
  is_subgraph A C``,
  fs[is_subgraph_def]>>
  metis_tac[SUBSET_TRANS])

val undir_g_insert_props = store_thm("undir_g_insert_props",``
  undir_graph G ∧
  x ≠ y ⇒
...
val colouring_satisfactory_subgraph = store_thm("colouring_satisfactory_subgraph",``
  is_subgraph G H ∧
