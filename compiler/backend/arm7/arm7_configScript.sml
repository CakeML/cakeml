...
val arm7_stack_conf = ``<|jump:=T;reg_names:=arm7_names;perf_calls:=F|>``
val arm7_lab_conf = ``<|pos:=0;ffi_names:=NONE;labels:=LN;sec_pos_len:=[];init_clock:=5;hash_size:=104729n;shmem_extra:=[]|>``
