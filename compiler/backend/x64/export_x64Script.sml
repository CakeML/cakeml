...
val ffi_asm_def = Define `
  ...
  (ffi_asm (ffi::ffis) =
      SmartAppend (List [
       ...
       implode"     pushq   %rax\n";
       implode"     jmp     wcdecl(ffi"; implode ffi; implode")\n";
       implode"     .p2align 4\n";
       implode"\n"]) (ffi_asm ffis))`
...
val windows_ffi_asm_def = Define `
  ...
  (windows_ffi_asm (ffi::ffis) =
      SmartAppend (List [
       implode"windows_ffi"; implode ffi; implode":\n";
       implode"     movq    %rcx, %r9\n";
       implode"     movq    %rdx, %r8\n";
       implode"     movq    %rsi, %rdx\n";
       implode"     movq    %rdi, %rcx\n";
       implode"     jmp     cdecl(ffi"; implode ffi; implode")\n";
...
(*
  EVAL``append(split16 (words_line (implode"\t.quad ") word_to_string) [100w:word64;393w;392w])``
