...
Definition optimise_def:
  optimise split_seq cut_size (name,arity,exp,md) =
    (name,arity,bvl_handle$compile_any split_seq cut_size arity
                  (let_op_sing (HD (remove_ticks [exp]))),md)
End
