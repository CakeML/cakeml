...
open lem_pervasivesTheory libTheory compilerLibTheory intLangTheory astTheory conLangTheory patLangTheory bytecodeTheory;
...
(CLet T Ce1
    (CLet T (shift( 1)( 0) Ce2)
      (CIf (CPrim2 (P2p CLt) (CVar( 0)) (CLit (IntLit(( 0 : int)))))
           (CRaise (CCon subscript_tag []))
           (CIf (CPrim2 (P2p CLt) (CVar( 0)) (CPrim1 CLenK (CVar( 1))))
...
/\
(v_to_Cv (Vectorv_pat vs) = (CConv bytecode$vector_tag (vs_to_Cvs vs)))
/\
(vs_to_Cvs [] = ([]))
/\
