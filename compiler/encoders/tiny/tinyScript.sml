(* tinyScript.sml - generated by L3 - Wed Aug 30 14:21:40 2017 *)
          ...
          Apply
            (Call
               ("norm",ATy(qTy,qTy),
                TP[Var("func",CTy"funcT"),LT,LF,Var("w",FTy 6),
                   Var("v0",F32),Var("v0",F32)]),
             ITE(Bop(Ule,Var("v0",F32),Dest("lastMemAddr",F32,qVar"state")),
                 Rupd
                   ("MEM",
                    TP[qVar"state",
                       Fupd
