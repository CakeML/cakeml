(* tinyScript.sml - generated by L3 - Wed Aug 30 09:57:29 2017 *)
...
val _ = Construct
  [("funcT",
    [("fAdd",[]),("fAddWithCarry",[]),("fSub",[]),("fCarry",[]),
     ("fOverflow",[]),("fLongMul",[]),("fLongMulH",[]),
     ("fLongHulHSigned",[]),("fAnd",[]),("fOr",[]),("fXor",[]),
     ("fEqual",[]),("fLess",[]),("fLower",[]),("fSnd",[]),("fReserved",[])])]
;
val _ = Construct
  [("shiftT",
...
val _ = Construct
  [("instruction",
    [("Accelerator",[PTy(FTy 6,CTy"reg_immT")]),
     ("Jump",[PTy(CTy"funcT",PTy(FTy 6,CTy"reg_immT"))]),
     ("JumpIfNotZero",
...
val _ = Record
  ("tiny_state",
   [("CarryFlag",bTy),("MEM",ATy(F32,F8)),("OutStrobe",F32),
    ("OverflowFlag",bTy),("PC",F32),("R",ATy(FTy 6,F32)),("Reset",bTy),
    ("f",ATy(F32,F32)),("lastMemAddr",F32)])
;
      ...
      CS(Var("func",CTy"funcT"),
         [(LC("fAdd",CTy"funcT"),
          ...
          (LC("fAddWithCarry",CTy"funcT"),
           Let(Var("v",F32),
               Bop(Add,Bop(Add,Var("a",F32),Var("b",F32)),
                         ...
                         Bop(Le,Bop(Exp,LN 2,LN 32),
                             Bop(Add,
                                 Bop(Add,Mop(Cast nTy,Var("a",F32)),
                                     Mop(Cast nTy,Var("b",F32))),
                                 Mop(Cast nTy,
                                     Dest("CarryFlag",bTy,qVar"state"))))]),
                   TP[Var("v",F32),
                      Rupd
                        ("OverflowFlag",
                         TP[qVar"s",
                            Mop(Not,
                                EQ(Mop(Cast iTy,Var("v",F32)),
                                   Bop(Add,
                                       Bop(Add,Mop(Cast iTy,Var("a",F32)),
                                           Mop(Cast iTy,Var("b",F32))),
                                       Mop(Cast iTy,
                                           Dest("CarryFlag",bTy,qVar"s")))))])]))),
          (LC("fSub",CTy"funcT"),
          ...
          (LC("fLongMul",CTy"funcT"),TP[LW(0,32),qVar"state"]),
          (LC("fLongMulH",CTy"funcT"),TP[LW(0,32),qVar"state"]),
          (LC("fLongHulHSigned",CTy"funcT"),TP[LW(0,32),qVar"state"]),
          (LC("fReserved",CTy"funcT"),TP[LW(0,32),qVar"state"])])))
;
val shift_def = Def
  ("shift",TP[Var("shiftOp",CTy"shiftT"),Var("a",F32),Var("b",F32)],
   CS(Var("shiftOp",CTy"shiftT"),
      [(LC("shiftLL",CTy"shiftT"),Bop(Lsl,Var("a",F32),Var("b",F32))),
       ...
       (LC("shiftReserved",CTy"shiftT"),LW(0,32))]))
;
val incPC_def = Def
  ("incPC",AVar uTy,
   Close
...
val norm_def = Def
  ("norm",
   TP[Var("func",CTy"funcT"),bVar"wback",bVar"strobe",Var("w",FTy 6),
      Var("a",F32),Var("b",F32)],
   Close
     (qVar"state",
          ...
          Let(Var("v0",F32),
              ...
              Apply
                (Call
                   ("norm",ATy(qTy,qTy),
                    TP[Var("func",CTy"funcT"),LT,LF,Var("w",FTy 6),
                       Var("v",F32),Var("v0",F32)]),
                 ITE(Bop(Ule,Var("v0",F32),
                         Dest("lastMemAddr",F32,qVar"state")),
                     Let(Var("alignedAddr",F32),
                         CC[EX(Var("v0",F32),LN 31,LN 2,FTy 30),LW(0,2)],
                         Let(qVar"s",
                             Rupd
                               ("MEM",
                                TP[qVar"state",
                                     ...
                                     Rupd
                                       ("MEM",
                                        TP[qVar"s",
                                           Fupd
                                             (Dest
                                                ("MEM",ATy(F32,F8),qVar"s"),
                                              Bop(Add,
                                                  Var("alignedAddr",F32),
                                                  LW(2,32)),
                                              EX(Var("v",F32),LN 23,LN 16,
                                                 F8))]),
                                     Rupd
                                       ("MEM",
                                        TP[qVar"s",
                     ...
                     Rupd
                       ("MEM",
                        TP[qVar"state",
                           Fupd
                             (Dest("MEM",ATy(F32,F8),qVar"state"),
                              Var("v0",F32),EX(Var("v",F32),LN 7,LN 0,F8))]),
                     qVar"state"))))))
;
   ...
   Close
     (qVar"state",
      Let(Var("v",F32),
          ...
          Apply
            (Call("incPC",ATy(qTy,qTy),LU),
             ITE(Bop(Ule,Var("v",F32),Dest("lastMemAddr",F32,qVar"state")),
                 Let(Var("alignedAddr",F32),
                     CC[EX(Var("v",F32),LN 31,LN 2,FTy 30),LW(0,2)],
                     Rupd
                       ("R",
                        TP[qVar"state",
                           Fupd
         ...
         [(Const("ReservedInstr",CTy"instruction"),qVar"state"),
          ...
          (Call
             ("Jump",CTy"instruction",
              Var("v2",PTy(CTy"funcT",PTy(FTy 6,CTy"reg_immT")))),
           Apply
             (Call
          ...
          (Call
             ("LoadConstant",CTy"instruction",
              Var("v5",PTy(FTy 6,PTy(bTy,FTy 23)))),
           Apply
             (Call
                ("dfn'LoadConstant",ATy(qTy,qTy),
                 Var("v5",PTy(FTy 6,PTy(bTy,FTy 23)))),qVar"state")),
          (Call
             ("LoadMEM",CTy"instruction",
              Var("v6",PTy(FTy 6,CTy"reg_immT"))),
           Apply
             (Call
                ("dfn'LoadMEM",ATy(qTy,qTy),
                 Var("v6",PTy(FTy 6,CTy"reg_immT"))),qVar"state")),
          (Call
          ...
          (Call
             ("LoadUpperConstant",CTy"instruction",
              Var("v8",PTy(FTy 6,FTy 9))),
           Apply
             (Call
                ("dfn'LoadUpperConstant",ATy(qTy,qTy),
                 Var("v8",PTy(FTy 6,FTy 9))),qVar"state")),
          (Call
...
val Next_def = Def
  ("Next",qVar"state",
   ITB([(Dest("Reset",bTy,qVar"state"),Rupd("PC",TP[qVar"state",LW(0,32)])),
        (Bop(Ule,Dest("PC",F32,qVar"state"),
             Dest("lastMemAddr",F32,qVar"state")),
         Let(Var("v",F32),
                   ...
                   Call
                     ("Decode",CTy"instruction",
                      CC[Apply
                         ...
                         Apply
                           (Dest("MEM",ATy(F32,F8),qVar"state"),
                            Var("v",F32))])),qVar"state")))],qVar"state"))
;
val ri2bits_def = Def
      ...
      [(Call
       ...
       (Call
        ...
        Call
          ("enc",F32,
           TP[Var("func",CTy"funcT"),Var("w",CTy"reg_immT"),
              Var("a",CTy"reg_immT"),Var("b",CTy"reg_immT"),LW(9,6)])),
       (Call
          ("JumpIfNotZero",CTy"instruction",
           TP[Var("func",CTy"funcT"),Var("w",CTy"reg_immT"),
              Var("a",CTy"reg_immT"),Var("b",CTy"reg_immT")]),
