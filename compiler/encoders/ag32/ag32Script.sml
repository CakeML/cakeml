(* ag32Script.sml - generated by L3 - Fri Sep 07 18:51:40 2018 *)
...
;
val print_string_max_length_def = Def0 ("print_string_max_length",LN 63)
;
val get_print_string_length_def = Def
  ("get_print_string_length",
   TP[Var("string_start",F32),nVar"length",Var("mem",ATy(F32,F8))],
   ITE(EQ(nVar"length",LN 0),LS"",
       LLC([Mop(Cast cTy,
                Apply(Var("mem",ATy(F32,F8)),Var("string_start",F32)))],
           Call
             ("get_print_string_length",sTy,
              TP[Bop(Add,Var("string_start",F32),LW(1,32)),
                 Bop(Sub,nVar"length",LN 1),Var("mem",ATy(F32,F8))]))))
;
val get_print_string_def = Def
  ("get_print_string",TP[Var("string_start",F32),Var("mem",ATy(F32,F8))],
   Call
     ("get_print_string_length",sTy,
      TP[Bop(Add,Var("string_start",F32),LW(1,32)),
         Mop(Min,
             TP[Mop(Cast nTy,
                    Apply(Var("mem",ATy(F32,F8)),Var("string_start",F32))),
                Const("print_string_max_length",nTy)]),
         Var("mem",ATy(F32,F8))]))
;
