...
open lem_pervasivesTheory lem_stringTheory libTheory astTheory compilerLibTheory intLangTheory toIntLangTheory bytecodeTheory patLangTheory;
...
(let nk = (LENGTH defs) in
  ...
  let (s,k13998) = (FOLDL (cons_closure env sz nk) (s, 0) ecs) in
  (* cl_1, ..., cl_nk, RefPtr_1 0, ..., RefPtr_nk 0, *)
  let (s,k13999) = (num_fold (update_refptr nk) (s, 0) nk) in
...
(if k = 0 then []
  ...
  (case (n13614 ) of ( _ ) => Store (k -  1) )) j)++(stackshift( 0) (k - j))
