...
open lem_pervasivesTheory semanticPrimitivesTheory astTheory bigStepTheory intLang2Theory;
...
((case (op, v1, v2) of
    ...
    | (Opn op, Litv_i4 (IntLit n1), Litv_i4 (IntLit n2)) =>
        if ((op = Divide) \/ (op = Modulo)) /\ (n2 =( 0 : int)) then
          SOME (exn_env_i4, s, Raise_i4 (Con_i4 intLang2$div_tag []))
        else
    ...
    | (Equality, v1, v2) =>
        (case do_eq_i4 v1 v2 of
            Eq_type_error => NONE
          | Eq_closure => SOME (exn_env_i4, s, Raise_i4 (Con_i4 intLang2$eq_tag []))
