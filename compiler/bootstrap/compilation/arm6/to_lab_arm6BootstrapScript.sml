...
val _ = new_theory "to_lab_arm6Bootstrap";
...
val to_data_thm0 =
  MATCH_MP backendTheory.to_data_change_config to_data_arm6_thm
...
val stack_to_lab_thm = save_thm("stack_to_lab_thm",
  compilationLib.compile_to_lab data_prog_arm6_def to_data_thm1 "lab_prog");
