...
*)
open preamble
open semanticsPropsTheory backendProofTheory arm8_configProofTheory compiler64ProgTheory
open evaluateTheory
...
Theorem evaluate_Eval:
  ...
  compile_inc_progs_for_eval arm8_config (id1,s1,decs) = SOME (s2,bs,ws) ∧
...
Proof
  ...
  \\ ‘compiler_agrees (compiler_inst arm8_config) (id1,s1_v,decs) (s2_v,bs_v,ws_v)’ by
