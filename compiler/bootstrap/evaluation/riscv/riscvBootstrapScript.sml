open preamble to_lab_riscvBootstrapTheory compilationLib

val _ = new_theory "riscvBootstrap";
...
(*
  val lab_prog_def =
    let
      val (ls,ty) = to_lab_riscvBootstrapTheory.lab_prog_def |> rconc |> listSyntax.dest_list
