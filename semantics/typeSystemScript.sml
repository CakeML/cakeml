...
open lem_pervasives_extraTheory libTheory fpValTreeTheory astTheory namespaceTheory semanticPrimitivesTheory;
...
val _ = Define `
 ((type_op:op ->(t)list -> t -> bool) op ts t=
   ((case (op,ts) of
    ...
    | (Real_cmp _, [t1; t2]) => (t1 = Treal) /\ (t2 = Treal) /\ (t = Tbool)
