...
(* Some abbreviations *)
val _ = Define `
 (Tarray_num : type_ident= (( 0 : num)))`;

val _ = Define `
 (Tbool_num : type_ident= (( 1 : num)))`;

val _ = Define `
 (Tchar_num : type_ident= (( 2 : num)))`;

val _ = Define `
 (Texn_num : type_ident= (( 3 : num)))`;

val _ = Define `
 (Tfn_num : type_ident= (( 4 : num)))`;

val _ = Define `
 (Tint_num : type_ident= (( 5 : num)))`;
...
(t1 = Tword8array) /\ (t2 = Tint) /\ (t3 = Tint) /\ (t4 = Tword8array) /\ (t5 = Tint) /\ (t = Ttup [])
    ...
    | (ListAppend, [Tapp [t1] ctor1; Tapp [t2] ctor2]) => (t1 = t2) /\ (ctor1 = Tlist_num) /\ (ctor2 = Tlist_num)
    | _ => F
  )))`;
