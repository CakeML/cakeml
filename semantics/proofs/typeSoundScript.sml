...
Theorem LUPDATE_too_long:
 !ll n x. LENGTH ll <= n ==>  LUPDATE x n ll = ll
Proof
...
Theorem fixshiftl_length:
 !x n. LENGTH (fixshiftl x n) = LENGTH x
Proof
  simp[fixshiftl_def]
QED

Theorem fixshiftr_length:
 !x n. LENGTH (fixshiftr x n) = LENGTH x
Proof
  simp[fixshiftr_def]
QED

Theorem fixasr_length:
 !x n. LENGTH (fixasr x n) = LENGTH x
Proof
...
Theorem opw_lookup_length:
 !op x y. (LENGTH y = LENGTH x) ==> LENGTH (opw_lookup op x y) = LENGTH x
Proof
...
Theorem shift_lookup_length:
 !sh x n. LENGTH (shift_lookup sh x n) = LENGTH x
Proof
