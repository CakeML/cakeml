...
val do_fp_top_def = Define`
  (do_fp_top top w1 w2 w3 =
    if LENGTH w1 = 64 /\ LENGTH w2 = 64 /\ LENGTH w3 = 64 then
       SOME (w2v (fp_top top (v2w w1) (v2w w2) (v2w w3)))
    else NONE)`;
val _ = export_rewrites["do_fp_top_def"];
