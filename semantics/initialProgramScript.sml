...
open lem_pervasivesTheory libTheory astTheory environmentTheory ffiTheory semanticPrimitivesTheory evaluateTheory typeSystemTheory;
...
(*val basis_sem_env : forall 'ffi. Eq 'ffi => ffi_state 'ffi -> maybe (state 'ffi * sem_env v)*)
val _ = Define `
 (basis_sem_env ffi =  
