...
open TypeSystemTheory BigStepTheory SmallStepTheory SemanticPrimitivesTheory ElabTheory AstTheory TokensTheory LibTheory
...
(
evaluate' s env e (s', Rerr err) /\ ALL_DISTINCT (pat_bindings p []))
==>
