...
open lem_pervasivesTheory lem_listTheory libTheory fpValTreeTheory lem_list_extraTheory lem_stringTheory lem_string_extraTheory astTheory namespaceTheory ffiTheory fpSemTheory fpOptTheory realOpsTheory;
...
val _ = Define `
 ((real_uop_type_num:num)  : num= (( 17 : num)))`;

val _ = Define `
 ((real_bop_type_num:num)  : num= (( 18 : num)))`;

val _ = Define `
 ((real_cmp_type_num:num)  : num= (( 19 : num)))`;

val _ = Define `
 ((op_type_num:num)        : num= (( 20 : num)))`;

val _ = Define `
 ((locn_type_num:num)      : num= (( 21 : num)))`;

val _ = Define `
 ((locs_type_num:num)      : num= (( 22 : num)))`;

val _ = Define `
 ((fp_opt_num:num)         : num= (( 23 : num)))`;

val _ = Define `
 ((exp_type_num:num)       : num= (( 24 : num)))`;

val _ = Define `
 ((dec_type_num:num)       : num= (( 25 : num)))`;
...
(*val enc_scope: fp_opt -> v*)
 val _ = Define `
  ...
  ((enc_scope:fp_opt -> v) (Opt)=  (Conv (SOME (TypeStamp "Opt" fp_opt_num)) []))
/\
  ((enc_scope:fp_opt -> v) (NoOpt)=  (Conv (SOME (TypeStamp "Noopt" fp_opt_num)) []))`;
...
(*val do_fpoptimise : fp_opt -> list v -> list v*)
 ...
 ((do_fpoptimise:fp_opt ->(v)list ->(v)list) sc []=  ([]))
    ...
    /\ ((do_fpoptimise:fp_opt ->(v)list ->(v)list) sc [Env env n]=
         ([Env env n]))
