...
(*val do_fpoptimise : fp_opt -> list v -> list v*)
 val do_fpoptimise_list_defn = Defn.Hol_multi_defns `
...
val _ = Lib.with_flag (computeLib.auto_import_definitions, false) (List.map Defn.save_defn) do_fpoptimise_list_defn;
