...
open pervasives_extraTheory libTheory astTheory;
...
((case lookup instance_Basic_classes_Eq_var_dict cn ctors of
      (SOME cid) =>
...
(let ts' = ((MAP (elab_t type_bound) ts)) in
    (case lookup instance_Basic_classes_Eq_var_dict tn type_bound of
