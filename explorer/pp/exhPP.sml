...
val _=temp_add_user_printer("exh_initglobal",``App_exh (Init_global_var_i2 n) x``,i2_initglobalPrint);
...
(*exh_Apply*)
val _=temp_add_user_printer ("exh_oppappprint", ``App_exh (Op_i2 Opapp) ls``, genPrint oppappPrint);
