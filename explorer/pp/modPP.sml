...
(*i1 binops*)
val _=temp_add_user_printer ("i1_assignappprint", ``App_i1 Opapp [Var_global_i1 10; x]``,genPrint (infixappPrint ":=")); 
val _=temp_add_user_printer ("i1_eqappprint", ``App_i1 Opapp [Var_global_i1 9; x]``,genPrint (infixappPrint "=")); 
val _=temp_add_user_printer ("i1_gteqappprint", ``App_i1 Opapp [Var_global_i1 8; x]``,genPrint (infixappPrint ">=")); 
val _=temp_add_user_printer ("i1_lteqappprint", ``App_i1 Opapp [Var_global_i1 7; x]``,genPrint (infixappPrint "<=")); 
val _=temp_add_user_printer ("i1_gtappprint", ``App_i1 Opapp [Var_global_i1 6; x]``,genPrint (infixappPrint ">")); 
val _=temp_add_user_printer ("i1_ltappprint", ``App_i1 Opapp [Var_global_i1 5; x]``,genPrint (infixappPrint "<")); 
val _=temp_add_user_printer ("i1_modappprint", ``App_i1 Opapp [Var_global_i1 4; x]``,genPrint (infixappPrint "mod")); 
val _=temp_add_user_printer ("i1_divappprint", ``App_i1 Opapp [Var_global_i1 3; x]``,genPrint (infixappPrint "div")); 
val _=temp_add_user_printer ("i1_timesappprint", ``App_i1 Opapp [Var_global_i1 2; x]``,genPrint (infixappPrint "*")); 
val _=temp_add_user_printer ("i1_minusappprint", ``App_i1 Opapp [Var_global_i1 1; x]``,genPrint (infixappPrint "-")); 
val _=temp_add_user_printer ("i1_addappprint", ``App_i1 Opapp [Var_global_i1 0; x]``,genPrint (infixappPrint "+")); 

(*i1 uops*)
val _=temp_add_user_printer ("i1_refappprint", ``App_i1  Opapp [Var_global_i1 13; x]``,genPrint (prefixappPrint "ref")); 
val _=temp_add_user_printer ("i1_derefappprint", ``App_i1 Opapp [Var_global_i1 12;x]``,genPrint (prefixappPrint "!"));
val _=temp_add_user_printer ("i1_negappprint", ``App_i1 Opapp [Var_global_i1 11; x]``,genPrint (prefixappPrint "~"));
