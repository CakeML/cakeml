...
struct
  ...
  fun do_stuff theAST theAST_pre =
  let
...
*)
  ...
  (* TODO: Use numArgs to implement selection of correct main/reader *)
  fun define_benchmark theAST theAST_pre benchmarking =
    let
      ...
      val doppler_env = st_no_doppler
                          ...
                          |> ml_progLib.remove_snocs
                          |> ml_progLib.get_env
      val doppler_env_def = bossLib.Define ‘doppler_env = ^doppler_env’
      val _ = append_prog (theOptProg_def |> concl |> rhs)
