...
Proof
  ...
  \\ Cases_on ‘op’ \\ fs[list_case_eq, option_case_eq, pair_case_eq] \\ rveq
...
Proof
  ...
  >- (
    fs[usedVars_def])
  \\ Cases_on ‘op’ \\ fs[list_case_eq, option_case_eq] \\ rveq
  \\ TRY (Cases_on ‘f’) \\ fs[option_case_eq, pair_case_eq]
