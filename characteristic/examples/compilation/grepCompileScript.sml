...
open x64_compileLib x64_exportLib grepProgTheory
...
val grep_prog = grep_prog_def |> REWRITE_RULE [listTheory.SNOC_APPEND, listTheory.APPEND] |> concl |> rand

val grep_compiled = to_bytes 3 ``x64_compiler_config`` grep_prog

val grep_bytes = extract_bytes grep_compiled

val store2 = save_thm ("grep", grep_compiled)
val store1 = write_asm [ ("grep", grep_bytes) ]
