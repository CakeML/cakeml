...
val _ = OpenTheoryMap.OpenTheory_const_name {const={Thy="holLight",Name="replicate"},name=(["Data","List"],"replicate")};
...
val _ = OpenTheoryMap.OpenTheory_const_name {const={Thy="holLight",Name="infinite"},name=(["Set"],"infinite")};
...
val _ = store(``!m a b. (!y. measure m y a ==> measure m y b) <=> m a <= m b``,
  ...
  THEN REPEAT STRIP_TAC THEN REVERSE EQ_TAC THEN REPEAT STRIP_TAC
...
val thms = Net.listItems (read_article "model-syntax.art" reader) handle e => Raise e
