 ...
 val abc_tac =
  ...
  >- (
   ...
   >- (
    ...
    ‘LENGTH r' = 0’ by cheat >> cases_on ‘r'’ >> fs [] >>
    fs [assign_ret_def, nested_seq_def] >>
    TOP_CASE_TAC >> fs []
    >- (
     fs [evaluate_def] >>
     cases_on ‘eval t x0’ >> fs [] >>
