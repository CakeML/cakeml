  ...
  >- (
   ...
   >- (
    ...
    >- (
     ...
     rw [] >>
     (* this is tricky *)
     (* should I add the assigned variables in the assumption *)
    *)
    conj_tac
    >- (
   ...
   >- (
    ...
    impl_tac >- cheat >>
    disch_then (qspec_then ‘(start,2)’ mp_tac) >>
    fs [comp_def] >>
    strip_tac >>
    ...
    impl_tac >-
     ...
     Cases_on ‘x’ >> fs [] >> rveq >> fs [] >>
     fs [state_rel_def] >>
     ‘t''.ffi.io_events = t1.ffi.io_events’ by cheat >>
     fs []) >>
