...
Proof
  ...
  simp[GSYM real_sigmaTheory.SUM_LMUL]>>
  Cases_on`r=0`
  >- (
...
Proof
  rw[eval_lhs_sum] >>
  simp[EQ_SYM_EQ]>>
  match_mp_tac real_sigmaTheory.SUM_SUPERSET>>
...
Proof
  ...
  DEP_REWRITE_TAC [real_sigmaTheory.SUM_UNION]>>
  simp[]>>
  CONJ_TAC >-
  ...
  match_mp_tac arith2>>
  reverse CONJ_TAC>-(
    DEP_REWRITE_TAC[GSYM real_sigmaTheory.SUM_ADD']>>
    simp[]>>
    match_mp_tac real_sigmaTheory.SUM_EQ'>>
