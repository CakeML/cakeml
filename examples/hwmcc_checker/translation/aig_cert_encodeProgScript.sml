...
val r = translate xaig_cert_encodeTheory.mapi_xori_num_aux_def;
val r = translate xaig_cert_encodeTheory.mapi_xori_num_def;
val r = translate xaig_cert_encodeTheory.and_genlist_num_aux_def;
val r = translate xaig_cert_encodeTheory.and_genlist_num_def;
val r = translate xaig_cert_encodeTheory.encode_xis_next_num_def;

val r = translate xaig_cert_encodeTheory.latch_reset_pairs_gen_def;

(* instantiate to avoid weird translation error *)
val r = translate
          (xaig_cert_encodeTheory.encode_xis_reset_gen_num_def
           |> INST_TYPE [alpha |-> “:num”, beta |-> “:num”]);

val r = translate xaig_cert_encodeTheory.mapi_impi_num_aux_def;
val r = translate xaig_cert_encodeTheory.mapi_impi_num_def;
val r = translate
          (xaig_cert_encodeTheory.encode_signal_imply_num_def
           |> INST_TYPE [alpha |-> “:num”, beta |-> “:num”]);

val r = translate xaig_cert_encodeTheory.mapi_ori_num_aux_def;
val r = translate xaig_cert_encodeTheory.mapi_ori_num_def;
val r = translate
          (xaig_cert_encodeTheory.encode_lives_hold_num_def
           |> INST_TYPE [alpha |-> “:num”, beta |-> “:num”]);

val r = translate xaig_cert_encodeTheory.encode_reset_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_transition_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_safety_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_base_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_induction_cond_num_fused;

val r = translate xaig_cert_encodeTheory.encode_liveness_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_decrease_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_closure_cond_num_fused;
val r = translate xaig_cert_encodeTheory.encode_stable_cond_num_fused;
