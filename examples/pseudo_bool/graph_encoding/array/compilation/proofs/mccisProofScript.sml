...
Theorem machine_code_sound:
  ...
  machine_sem mc (basis_ffi ext cl fs) ms ⊆
    extend_with_resource_limit
      {Terminate Success (cake_pb_mccis_io_events ext cl fs)} ∧
  ∃out err.
    extract_fs ext (cl,fs) (cake_pb_mccis_io_events ext cl fs) =
...
Proof
  ...
  drule_at (Pos last) cake_pb_mccis_compiled_thm>>
  simp[AND_IMP_INTRO]>>
  disch_then drule>>
