...
val (cake_pb_wcnf_not_fail,cake_pb_wcnf_sem_sing) = cake_pb_wcnf_sem
  |> SRULE [wcnf_compiled,ml_progTheory.prog_syntax_ok_semantics]
...
Theorem cake_pb_wcnf_compiled_thm =
