(*
This file was written by Alexander Cox for his Honours in AUC Canberra where he attempted to formalize the DEFLATE Specification in HOL. His consent has been given for it to be used in this formalization
*)
