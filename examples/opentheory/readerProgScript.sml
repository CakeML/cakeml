...
(*
 * This is the drop-in replacement for inputAllTokensFile for
...
Theorem inputAllTokensFile_spec2:
  FILENAME fn fnv ∧
  hasFreeFD fs ⇒
    app (p: 'ffi ffi_proj) TextIO.inputAllTokensFile_v
