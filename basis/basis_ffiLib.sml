...
fun subset_basis_st st precond =
  ...
  val tac = (
     ...
     \\ fs[Abbr`ffii`,cfAppTheory.store2heap_aux_append_many]
     \\ EVAL_TAC
     \\ rw[INJ_MAP_EQ_IFF,INJ_DEF,FLOOKUP_UPDATE,
           cfAppTheory.store2heap_aux_append_many,cfStoreTheory.store2heap_aux_def])
