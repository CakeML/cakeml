...
val explode_side_thm = Q.prove(
  `explode_1_side x`,
  rw[definition"explode_1_side_def",explode_aux_side_thm])
  |> update_precondition
...
val translate_side_def = definition"translate_1_side_def";
