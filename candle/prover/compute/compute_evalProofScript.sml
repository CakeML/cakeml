...
open compute_evalTheory computeSyntaxTheory computeSyntaxProofTheory;
...
Proof
  ntac 2 strip_tac
  \\ Cases_on ‘bop’ \\ gs [bop2term_def, do_binop_def]
  >~ [‘_CVAL_ADD _ _’] >- (
    Cases_on ‘∃m. x = Num m’ \\ fs []
    >- (
      Cases_on ‘∃n. y = Num n’ \\ fs []
      >- (
        gvs [do_add_def, st_ex_return_def, cval2term_def]
