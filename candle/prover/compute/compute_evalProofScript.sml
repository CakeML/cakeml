...
Theorem compute_eval_value:
  ...
  (∀ck ceqs cvs s xs s'.
    compute_eval_list ck ceqs cvs s = (M_success xs, s') ⇒ EVERY cval_value xs)
Proof
...
Proof
  ...
  \\ rename [‘mapOption I (MAP dest_cval tms)’]
  \\ ‘∀tm tm'.
  ...
  >~ [‘_CVAL_DIV _ _’] >- (
    ...
    >- (
      ...
      >- (
        ...
        \\ rw [CVAL_DIV_eqn1, sym_equation, num2bit_term_ok])
      \\ ‘cval_value y’
        by rw [compute_eval_value, SF SFY_ss]
      \\ ‘∃p1 q1. y = Pair p1 q1’
        by (Cases_on ‘y’ \\ fs [])
      ...
      \\ resolve_then Any irule sym_equation replaceL1
      \\ first_x_assum (irule_at Any)
      \\ rw [CVAL_DIV_eqn2, num2bit_term_ok, compute_thy_ok_terms_ok])
    \\ Cases_on ‘∃n. y = Num n’ \\ gs []
    >- (
      gvs [cval2term_def, do_arith_def, st_ex_return_def]
      \\ ‘cval_value x’
      ...
      \\ resolve_then Any irule sym_equation replaceL1
      \\ first_x_assum (irule_at Any)
      \\ rw [CVAL_DIV_eqn3, num2bit_term_ok, compute_thy_ok_terms_ok])
    \\ gvs [cval2term_def, do_arith_def, st_ex_return_def]
    \\ ‘cval_value x’
      by rw [compute_eval_value, SF SFY_ss]
    \\ ‘∃p1 q1. x = Pair p1 q1’
    ...
    \\ resolve_then Any irule sym_equation replaceL1
    \\ first_x_assum (irule_at Any)
    \\ fs [] \\ rw [CVAL_DIV_eqn4, compute_thy_ok_terms_ok])
  >~ [‘_CVAL_MOD _ _’] >- (
    Cases_on ‘∃m. x = Num m’ \\ fs []
    >- (
      Cases_on ‘∃n. y = Num n’ \\ fs []
      >- (
        ...
        \\ rw [CVAL_MOD_eqn1, sym_equation, num2bit_term_ok])
      \\ ‘cval_value y’
        by rw [compute_eval_value, SF SFY_ss]
      \\ ‘∃p1 q1. y = Pair p1 q1’
        by (Cases_on ‘y’ \\ fs [])
      ...
      \\ resolve_then Any irule sym_equation replaceL1
      \\ first_x_assum (irule_at Any)
      \\ rw [CVAL_MOD_eqn2, num2bit_term_ok, compute_thy_ok_terms_ok])
    \\ Cases_on ‘∃n. y = Num n’ \\ gs []
    >- (
      gvs [cval2term_def, do_arith_def, st_ex_return_def]
      \\ ‘cval_value x’
      ...
      \\ resolve_then Any irule sym_equation replaceL1
      \\ first_x_assum (irule_at Any)
      \\ rw [CVAL_MOD_eqn3, num2bit_term_ok, compute_thy_ok_terms_ok])
    \\ gvs [cval2term_def, do_arith_def, st_ex_return_def]
    \\ ‘cval_value x’
      by rw [compute_eval_value, SF SFY_ss]
    \\ ‘∃p1 q1. x = Pair p1 q1’
    ...
    \\ resolve_then Any irule sym_equation replaceL1
    \\ first_x_assum (irule_at Any)
    \\ fs [] \\ rw [CVAL_MOD_eqn4, compute_thy_ok_terms_ok])
  >~ [‘_CVAL_LESS _ _’] >- (
    Cases_on ‘∃m. x = Num m’ \\ fs []
    >- (
      Cases_on ‘∃n. y = Num n’ \\ fs []
...
Theorem compute_eval_thm:
  compute_thy_ok thy ⇒
    ...
    (∀ck eqs cvs s cvs' s' tm.
      ...
      EVERY (term_ok (sigof thy)) (MAP cval2term cvs) ∧
      EVERY (λcv. cval_vars cv = {}) cvs ∧
      EVERY (λ(f,vs,cv).
        ALL_DISTINCT vs ∧
        ∃r. (thy,[]) |- cval2term (App f (MAP Var vs)) === r ∧
            dest_cval r = SOME cv ∧
            cval_vars cv ⊆ set vs) eqs ⇒
        LIST_REL (λcv cv'. (thy,[]) |- cval2term cv === cval2term cv') cvs cvs'))
Proof
  strip_tac \\ fs []
  \\ ho_match_mp_tac compute_eval_ind \\ rw []
  \\ qpat_x_assum ‘_ = (M_success _, _)’ mp_tac
  ...
  >~ [‘Num n’] >- (
    strip_tac
    \\ gvs [cval2term_term_ok, proves_REFL])
  >~ [‘Pair p q’] >- (
    simp [Once st_ex_bind_def] \\ CASE_TAC \\ gs [] \\ CASE_TAC \\ gs []
  ...
  >~ [‘App f cs’] >- (
    ...
    \\ impl_keep_tac
    >- (
      gs [term_ok_def, cval_vars_def, cval2term_def]
