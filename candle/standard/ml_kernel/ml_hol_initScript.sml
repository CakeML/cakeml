...
val kernel_init_thm = store_thm("kernel_init_thm",
  ...
  \\ fs [HOL_STORE_def,isRefv_def,EVAL ``(candle_init_state ffi).refs``,
         GSYM init_context_def,init_context_v_thm,
         GSYM init_axioms_def,init_axioms_v_thm,
         GSYM init_term_constants_def,init_term_constants_v_thm,
         GSYM init_type_constants_def,init_type_constants_v_thm]
  \\ EVAL_TAC \\ fs []);
