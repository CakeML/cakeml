...
val the_type_constants = the_type_constants_def |> rconc |> rand;
val the_term_constants = the_term_constants_def |> rconc |> rand;
val the_axioms = the_axioms_def |> rconc |> rand;
val the_context = the_context_def |> rconc |> rand;

val HOL_STORE_init_precond = Q.store_thm ("HOL_STORE_init_precond",
  `HOL_STORE init_refs
   {Mem ^the_type_constants (Refv init_type_constants_v);
    Mem ^the_term_constants (Refv init_term_constants_v);
    Mem ^the_axioms         (Refv init_axioms_v);
    Mem ^the_context        (Refv init_context_v)}`,
  qabbrev_tac `l4 = ^the_context`
  \\ qabbrev_tac `l3 = ^the_axioms`
  \\ qabbrev_tac `l2 = ^the_term_constants`
  \\ qabbrev_tac `l1 = ^the_type_constants`
  \\ rw[HOL_STORE_def,ml_monad_translatorBaseTheory.REF_REL_def,init_refs_def]
  \\ rw[STAR_def,SEP_EXISTS_THM]
  \\ qmatch_goalsub_abbrev_tac`Mem l1 v1`
  \\ qmatch_goalsub_abbrev_tac`Mem l2 v2`
  \\ qmatch_goalsub_abbrev_tac`Mem l3 v3`
  \\ qmatch_goalsub_abbrev_tac`Mem l4 v4`
  \\ qexists_tac`{Mem l1 v1; Mem l2 v2; Mem l3 v3}`
  \\ qexists_tac`{Mem l4 v4}`
  \\ `l1 < l2` by simp[Abbr`l1`,Abbr`l2`]
  \\ `l2 < l3` by simp[Abbr`l2`,Abbr`l3`]
  \\ `l3 < l4` by simp[Abbr`l3`,Abbr`l4`]
  \\ conj_tac >- SPLIT_TAC
  \\ reverse conj_tac
  >- (
    ...
    \\ unabbrev_all_tac
    \\ SPLIT_TAC )
  \\ qexists_tac`{Mem l1 v1; Mem l2 v2}`
  \\ qexists_tac`{Mem l3 v3}`
  \\ conj_tac >- SPLIT_TAC
  \\ reverse conj_tac
  >- (
    ...
    \\ unabbrev_all_tac
    \\ SPLIT_TAC )
  \\ qexists_tac`{Mem l1 v1}`
  \\ qexists_tac`{Mem l2 v2}`
  \\ conj_tac >- SPLIT_TAC
  \\ reverse conj_tac
  >- (
