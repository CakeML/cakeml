...
`!count_e env s.
 ...
 >- ((* Handle *)
     ...
     >- (cases_on `err` >>
         fs [] >-
         metis_tac [] >-
         (`?count2 s2 r2. evaluate_match T (env0,env1,env2) (count1,s1) a l a ((count2,s2),r2)`
 ...
 >- ((* match *)
     ...
     rw [] >-
     metis_tac [] >>
     `?count2 s2 r2. evaluate_match T env (count1,s1) v l (Conv (SOME ("Bind", TypeExn NONE)) []) ((count2,s2),r2)`
