...
in
  ...
  val eval_cake_compile_ag32 =
      eval_cake_compile ag32_arch_thms;

  val eval_cake_compile_ag32_with_conf =
      eval_cake_compile_with_conf ag32_arch_thms;

  val eval_cake_compile_explore_ag32 =
      eval_cake_compile_explore ag32_arch_thms;

  val eval_cake_compile_explore_ag32_with_conf =
      eval_cake_compile_explore_with_conf ag32_arch_thms;

  val eval_cake_compile_ag32_general =
      eval_cake_compile_general ag32_arch_thms;
