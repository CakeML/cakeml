...
val pre = check_clash_tree'_eq |> cv_trans_pre;
...
val res = word_allocTheory.oracle_colour_ok_def
  |> SRULE [Once LET_THM,GREATER_EQ] |> arch_spec
  |> REWRITE_RULE (defs @ P_defs) |> cv_auto_trans;
