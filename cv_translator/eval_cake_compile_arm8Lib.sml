...
in
  ...
  val eval_cake_compile_arm8 = eval_cake_compile arm8_arch_thms;
  val eval_cake_compile_arm8_with_conf = eval_cake_compile_with_conf arm8_arch_thms;
  val eval_cake_compile_arm8_general = eval_cake_compile_general arm8_arch_thms;
