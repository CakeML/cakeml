...
val blast_align_lemma = blast_lemma;
...
val getTag_def = Define `(getTag (Block n x) = n) /\ (getTag _ = ARB)`;
...
(*
  ...
  TODO:
   - allow code in state ...................
   - verify install code for pop ...........
   - fix stack base ........................

  Goal of today:
   - setup all invariants correctly, zHEAP and zBC_HEAP
   - prove repl implemenatation with lots of cheats
