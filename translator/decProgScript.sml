...
val _ = register_type ``:real_uop``;
val _ = register_type ``:real_bop``;
val _ = register_type ``:real_cmp``;
...
val type_num_defs = LIST_CONJ
  [bool_type_num_def, list_type_num_def, option_type_num_def,
   ...
   fp_top_type_num_def, fp_opt_num_def, fp_cmp_type_num_def, real_uop_type_num_def,
   real_bop_type_num_def, real_cmp_type_num_def, op_type_num_def,
...
val FPVALTREE_FP_UOP_TYPE_def = my_fetch "FPVALTREE_FP_UOP_TYPE_def";
val FPVALTREE_FP_BOP_TYPE_def = my_fetch "FPVALTREE_FP_BOP_TYPE_def";
val FPVALTREE_FP_TOP_TYPE_def = my_fetch "FPVALTREE_FP_TOP_TYPE_def";
val FPVALTREE_FP_CMP_TYPE_def = my_fetch "FPVALTREE_FP_CMP_TYPE_def";
val FPVALTREE_FP_OPT_TYPE_def = my_fetch "FPVALTREE_FP_OPT_TYPE_def";
val REALOPS_REAL_UOP_TYPE_def = my_fetch "REALOPS_REAL_UOP_TYPE_def";
...
Theorem FPVALTREE_FP_UOP_TYPE_eq_enc:
  !l v. FPVALTREE_FP_UOP_TYPE l v <=> v = enc_fp_uop l
Proof
  Induct \\ fs [FPVALTREE_FP_UOP_TYPE_def,enc_fp_uop_def,type_num_defs]
QED

Theorem FPVALTREE_FP_BOP_TYPE_eq_enc:
  !l v. FPVALTREE_FP_BOP_TYPE l v <=> v = enc_fp_bop l
Proof
  Induct \\ fs [FPVALTREE_FP_BOP_TYPE_def,enc_fp_bop_def,type_num_defs]
QED

Theorem FPVALTREE_FP_TOP_TYPE_eq_enc:
  !l v. FPVALTREE_FP_TOP_TYPE l v <=> v = enc_fp_top l
Proof
  Induct \\ fs [FPVALTREE_FP_TOP_TYPE_def,enc_fp_top_def,type_num_defs]
QED

Theorem FPVALTREE_FP_CMP_TYPE_eq_enc:
  !l v. FPVALTREE_FP_CMP_TYPE l v <=> v = enc_fp_cmp l
Proof
  Induct \\ fs [FPVALTREE_FP_CMP_TYPE_def,enc_fp_cmp_def,type_num_defs]
QED

Theorem REALOPS_REAL_UOP_TYPE_eq_enc:
  !l v. REALOPS_REAL_UOP_TYPE l v <=> v = enc_real_uop l
Proof
  Induct \\ fs [REALOPS_REAL_UOP_TYPE_def,enc_real_uop_def,type_num_defs]
QED

Theorem REALOPS_REAL_BOP_TYPE_eq_enc:
  !l v. REALOPS_REAL_BOP_TYPE l v <=> v = enc_real_bop l
Proof
  Induct \\ fs [REALOPS_REAL_BOP_TYPE_def,enc_real_bop_def,type_num_defs]
QED

Theorem REALOPS_REAL_CMP_TYPE_eq_enc:
  !l v. REALOPS_REAL_CMP_TYPE l v <=> v = enc_real_cmp l
Proof
  Induct \\ fs [REALOPS_REAL_CMP_TYPE_def,enc_real_cmp_def,type_num_defs]
QED
...
Proof
  Induct \\ fs [AST_OP_TYPE_def,enc_op_def,type_num_defs,nat_to_v_def,
    ...
    FPVALTREE_FP_UOP_TYPE_eq_enc, FPVALTREE_FP_BOP_TYPE_eq_enc,
    FPVALTREE_FP_TOP_TYPE_eq_enc, FPVALTREE_FP_CMP_TYPE_eq_enc,
    REALOPS_REAL_UOP_TYPE_eq_enc, REALOPS_REAL_BOP_TYPE_eq_enc,
...
Proof
  Induct
  \\ gs[FPVALTREE_FP_OPT_TYPE_def, enc_scope_def, type_num_defs, fp_opt_num_def]
QED
