...
val word_lt_translation_test2 = Define`word_lt_translation_test2 (w1:word64) (w2:word64)
    = (w1 <+ w2 /\ w1 < w2)`
val res = translate word_lt_translation_test2;

val word_test_translation_test = Define`word_test_translation_test (w1:word64) (w2:word64)
    = (word_test w1 w2 /\ w1 < w2)`
val res = translate word_test_translation_test;
