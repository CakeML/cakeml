...
val word_and_or = Define`word_and_or (w1:word64) (w2:word64) = word_or (word_and w1 w2) w1`
val res = translate word_and_or;

val word_and_or_plus1 = Define`word_and_or_plus1 (w1:word64) (w2:word64) = (word_and_or w1 w2) + 1w`
...
val word_and_or_sub1 = Define`word_and_or_sub1 (w1:word64) (w2:word64) (w3:word64) = (word_and_or w1 w2) - w3`
...
(* fails translation with different constructors *)
val word_and_lt_word_or = Define`word_and_lt_word_or (w1:word64) (w2:word64) = word_lt (word_and w1 w2) (word_or w1 w2)`
