              ...
              (fn  x =>
                 ...
                 then  (st_ex_filter v4 v2 (v3::v5))
                  ...
                  (fn  v2 =>
                    (fn  v3 =>
                      (fn  v4 =>
                        if  (v4 < v2)
                        then  (let val  v1 = Array.sub ( degrees,v4)
                        in
                          v1 < v3
                         end)
                        else  (0 <= 0))))
                ...
                |   v3::v2 =>  (let val  v1 = insert_edge v5 v3
                 in
                  ...
                  (fn  v15 =>
                    (fn  v16 =>
                      let val  v14 = Array.update ( coalesced, v16,(SOME(v15)))
                          val  v13 = !(avail_moves_wl)
                          val  v12 =
                        avail_moves_wl := (List.map (pair_rename v15 v16) v13)
                          val  v11 = !(unavail_moves_wl)
                          val  v10 =
                        unavail_moves_wl := (List.map (pair_rename v15 v16) v11)
                      ...
                      (fn  v23 =>
                        ...
                        of  (v16,v15) =>  (let val  v14 =
                          st_ex_map (fn  v1 => (Array.sub ( degrees,v1))) v15
                            val  v12 =
                          List.length (List.filter (fn  v13 => (v13 >= v21)) v14)
                        in
                          if  (v12 = 0)
                        then  (0 <= 0)
                        else  (let val  v10 =
                          ...
                          List.length (List.filter (fn  v4 =>
                            ...
                            val  v6 =
                          List.length (List.filter (fn  v5 => (v5 >= v21)) v8)
                        in
                          ((v7 + v12) + v6) < v21
                         end)
                        end)
                ...
                in
                      ...
                      (fn  v27 =>
                        let val  v25 = count_list v26
                          ...
                          st_ex_foreach v25 (fn  v2 =>
                            ...
                            in
                              Array.update ( degrees, v2,(List.length v1))
                            end))
                  ...
                  (fn  v7 =>
                    let val  v6 = toalist v7
                      ...
                      st_ex_map (fn  v4 =>
                        (case  v4
                        of  (v3,v2) =>  (let val  v1 = Array.sub ( node_tag,v2)
                        in
                          (v3,extract_tag v1)
                        end))) v6
                     in
