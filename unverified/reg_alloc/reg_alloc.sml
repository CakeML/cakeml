structure reg_alloc = struct
      ...
      (fn v34 =>
        let val v26 =
          ...
          map (fn v24 =>
            ...
            val v18 =
          partition (fn v21 => (case v21 of (v20,v19) => (v19 < v33))) v23
        in
          case v18
  ...
  fun id_colour v3 =  foldr (fn v2 => (fn v1 => (insert v2 v2 v1))) Ln v3;
      ...
      (fn v24 =>
        ...
        in
          ...
          of (v17,v16) => (let val v15 =
                             aux_move_pref (ra_state_coalesced v16) (resort_moves (moves_to_sp v20 Ln))
                               val v14 =
                             alloc_colouring (ra_state_graph v16) v23 v15 (ra_state_stack v16)
                           in
                             case v14
                             of (v13,v12) => (let val v11 =
                                                full_coalesce (ra_state_graph v16) v23 v20 v12
                                              in
                                                case v11
                                                of (v10,v9) => (case v9
                                                                of (v8,v7) => (let val v6 =
                                                                                 sec_ra_state v10 v23 v8 v7
                                                                                   val v5 =
                                                                                 rpt_do_step2 v6
                                                                               in
                                                                                 case v5
                                                                                 of (v4,v3) => (let val v2 =
                                                                                                  spill_colouring v10 v23 v7 (ra_state_stack v3) v13
                                                                                                in
                                                                                                  spill_colouring v10 v23 Ln v12 v2
                                                                                                end)
                                                                               end))
                                              end)
                           end)
