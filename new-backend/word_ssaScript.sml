...
``∀prog st cst ssa na ns.
  ...
  >- (*Call*)
    ...
    >-
      ...
      >-
        (res_tac>>
        qpat_assum`A=domain(fromAList l'')` (SUBST_ALL_TAC o SYM)>>
     ...
     fs[]>>
      ...
      (*Probably isn't that hard but prove in a lemmam instead*)
  ...
  >>
    ...
    >-
      ...
      >-
        cheat (*This one might be a little bit tricky since we have to 
        go via st*)
      >-
        cheat
      >-
