...
open lem_pervasivesTheory alistTheory bitstringTheory bitstring_extraTheory llistTheory locationTheory sptreeTheory wordsTheory integer_wordTheory;
...
declare hol target_rep function integerFromBitstring = `v2i`
 *)
(*val natFromBitstring : list bool -> nat*)
