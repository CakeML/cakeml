...
val stacktest = eval ``stack_to_target$compile ^(x64_stack_conf) [0,(Seq (Skip:64 stackLang$prog) (StackStore 5 3 ))]``

(*Maybe make word take configs for the allocator too*)
val x64_word_conf = x64_stack_conf
val wordtest = eval ``word_to_target$compile ^(x64_word_conf) [0,2,(Seq (Assign 5 (Op Add [(Var 0);(Var 2)])) (Return 5 5))]``
...
val bvptest = eval ``bvp_to_target$compile ^(x64_bvp_conf) [0,2,(Seq (Move 5 0) (Return 5))]``

val bvitest = eval ``bvi_to_bvp$compile_part (0,5,(Var 3))``
val bvitest2 = eval ``bvi_to_target$compile ^(x64_bvp_conf) [(0,5,(Var 3))]``
